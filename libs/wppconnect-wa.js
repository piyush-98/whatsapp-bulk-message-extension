  ...
  var __webpack_modules__ = {
      ...
      48287: (e, t, r) => {
        ...
        function c(e, t, r) {
          ...
          const o = (function (e) {
            ...
            if (void 0 !== e.length)
              return "number" != typeof e.length || Q(e.length) ? s(0) : f(e);
        ...
        function z(e, t, r) {
          if (Math.floor(e) !== e)
            throw (
              (q(e, r), new U.ERR_OUT_OF_RANGE(r || "offset", "an integer", e))
            );
      ...
      23807: function (e) {
        e.exports = (function () {
                    ...
                    function (e) {
                      ...
                      for (
                        r = t[2]
                          ...
                          c = s ? atob(u) : decodeURIComponent(u),
          ...
          function P(e, t, r) {
            var n,
              o = "";
            for (r += t, n = t; n < r; n += 1) o += _(e.getUint8(n));
            return o;
          }
          var M = p.btoa;
          function w(e, t) {
            for (var r = [], n = 8192, o = new Uint8Array(e); o.length > 0; )
              r.push(_.apply(null, y(o.subarray(0, n)))), (o = o.subarray(n));
          ...
          function x(e) {
            ...
            if (i && a) {
              var s = r * t;
              (("contain" === o || "none" === o) && s > n) ||
              ("cover" === o && s < n)
                ? (r = n / t)
                : (n = r * t);
            } else i ? (r = n / t) : a && (n = r * t);
            return { width: n, height: r };
          }
          function I(e) {
            for (
              var t = y(new Uint8Array(e)), r = t.length, n = [], o = 0;
              o + 3 < r;

            ) {
              var i = t[o],
                a = t[o + 1];
              if (255 === i && 218 === a) break;
              if (255 === i && 216 === a) o += 2;
              else {
                var s = o + (256 * t[o + 2] + t[o + 3]) + 2,
                  u = t.slice(o, s);
                n.push(u), (o = s);
              }
            }
                    ...
                    value: function () {
                      ...
                      if (d(t)) {
                        ...
                        if (h(n))
                          if (k && T) {
                            A ||
                              ((r.checkOrientation = !1), (r.retainExif = !1));
                            var o = "image/jpeg" === n,
                              i = o && r.checkOrientation,
                              s = o && r.retainExif;
                            if (!k || i || s) {
                              var u = new T();
                              (this.reader = u),
                                ...
                                i || s
                                  ...
                                  : u.readAsDataURL(t);
                            } else this.load({ url: k.createObjectURL(t) });
                          } else
                            this.fail(
                              new Error(
                    ...
                    value: function (e) {
                      var t = this,
                        ...
                        v =
                          ...
                          g(p.width) &&
                          g(p.height),
                        _ = Math.max(p.maxWidth, 0) || 1 / 0,
                        P = Math.max(p.maxHeight, 0) || 1 / 0,
                        M = Math.max(p.minWidth, 0) || 0,
                        O = Math.max(p.minHeight, 0) || 0,
                        j = r / n,
                        S = p.width,
                        I = p.height;
                      if (b) {
                      ...
                      v && (j = S / I);
                      var L = x(
                        { aspectRatio: j, width: _, height: P },
                        "contain"
                      );
                      (_ = L.width), (P = L.height);
                      var R = x(
                        { aspectRatio: j, width: M, height: O },
                        "cover"
                      );
                      if (((M = R.width), (O = R.height), v)) {
                        var F = x(
                          { aspectRatio: j, width: S, height: I },
                          p.resize
                        );
                        (S = F.width), (I = F.height);
                      } else {
                        var N = x({ aspectRatio: j, width: S, height: I }),
                          U = N.width;
                        S = void 0 === U ? r : U;
                        var D = N.height;
                        I = void 0 === D ? n : D;
                      ...
                      var W =
                          -(S = Math.floor(C(Math.min(Math.max(S, M), _)))) / 2,
                        G =
                          -(I = Math.floor(C(Math.min(Math.max(I, O), P)))) / 2,
                        q = S,
                        z = I,
                        $ = [];
                      if (v) {
                        var V = 0,
                          ...
                          H = n,
                          Q = x(
                            { aspectRatio: j, width: r, height: n },
                      ...
                      (m.width = S),
                        (m.height = I),
                        h(p.mimeType) || (p.mimeType = d.type);
                      var Z = "transparent";
                      d.size > p.convertSize &&
                        p.convertTypes.indexOf(p.mimeType) >= 0 &&
                        (p.mimeType = "image/jpeg");
                      var X = "image/jpeg" === p.mimeType;
                      if (
                        (X && (Z = "#fff"),
                        (y.fillStyle = Z),
                        y.fillRect(0, 0, S, I),
                        p.beforeDraw && p.beforeDraw.call(this, y, m),
                        !this.aborted &&
                          (y.save(),
                          y.translate(S / 2, I / 2),
                          y.rotate((i * Math.PI) / 180),
                          y.scale(s, c),
                          y.drawImage.apply(y, [f].concat($)),
                          y.restore(),
                          p.drew && p.drew.call(this, y, m),
                          !this.aborted))
                      ) {
                        var ee = function (e) {
                          if (!t.aborted) {
                            ...
                            if (
                              ...
                              var i = function (e) {
                                return o(l(w(E(e, t.exif), p.mimeType)));
                              };
                              if (e.arrayBuffer)
                                e.arrayBuffer()
                                  .then(i)
                        ...
                        m.toBlob
                          ? m.toBlob(ee, p.mimeType, p.quality)
                          : ee(l(m.toDataURL(p.mimeType, p.quality)));
                      }
                    },
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (
                        ...
                        if (
                          ...
                          var s = new Date();
                          (n.lastModified = s.getTime()),
                            (n.lastModifiedDate = s),
                            (n.name = o.name),
                            n.name &&
                              n.type !== o.type &&
                              (n.name = n.name.replace(B, v(n.type)));
                        }
                      else n = o;
                      (this.result = n), a.success && a.success.call(this, n);
                    },
                  },
                  {
                    key: "fail",
      ...
      53011: (e, t, r) => {
        ...
        !(function (o) {
          ...
          function y(e, t) {
            for (
              var r = {}, n = e.length, i = t ? t.length : 0, a = 0;
              a < n;
              a++
            )
              r[e[a]] = a < i ? t[a] : o;
          ...
          function h(e, t, r, n) {
            ...
            function f(e) {
              throw Error(
                'Invalid "' + s + '" option value' + (e ? ". Reason: " + e : "")
              );
            }
            for (var p = 0; p < d; p++) {
          ...
          Object.assign(b.prototype, {
              ...
              var n = this,
                ...
                s = function () {
                  var n = m.apply(null, arguments),
                    a = { data: n, name: t, original: e };
                  r
                    ? !1 !== r.call(o, a) && i.emit.apply(i, [a.name].concat(n))
            ...
            unsubscribe: function (e) {
              ...
              function c() {
                o._onNewListener &&
                  (a.off("newListener", o._onNewListener),
                  a.off("removeListener", o._onRemoveListener),
          ...
          function w(e, t, r) {
            var n,
              ...
              i,
              a = 0,
              s = new e(function (u, c, l) {
                function d() {
                  o && (o = null), a && (clearTimeout(a), (a = 0));
                }
                (r = h(
                  r,
                ...
                n
                  ...
                  r.timeout > 0 &&
                    (a = setTimeout(function () {
                      var e = Error("timeout");
                      (e.code = "ETIMEDOUT"), (a = 0), s.cancel(e), c(e);
                    }, r.timeout));
              });
            return (
              n ||
                  ...
                  "_listeners" !== (p = h[s]) &&
                    ("*" === p || "**" === p
                      ? (r[p]._listeners &&
                          ...
                          (_ ? _.push.apply(_, v) : (_ = v)),
                        (v = j(e, t, r[p], n, o)))
                      : (v = j(e, t, r[p], p === M ? n + 2 : n, o)),
                    v && (_ ? _.push.apply(_, v) : (_ = v)));
                return _;
              }
              r[P] && (_ = j(e, t, r[P], n + 1, o));
            }
            if (((g = r["*"]) && j(e, t, g, n + 1, o), (m = r["**"])))
              if (n < o)
                for (
                  m._listeners && j(e, t, m, o, o), s = (h = d(m)).length;
                  s-- > 0;
          ...
          function C(e, t, r, n) {
            for (
              var o, i, a, s, u = d(e), c = u.length, l = e._listeners;
              c-- > 0;

            )
              (o = e[(i = u[c])]),
                (a = "_listeners" === i ? r : r ? r.concat(i) : [i]),
                (s = n || "symbol" == typeof i),
                l && t.push(s ? a : a.join(this.delimiter)),
                "object" == typeof o && C.call(this, o, t, a, s);
            return t;
          }
          function x(e) {
            for (var t, r, n, o = d(e), i = o.length; i-- > 0; )
              (t = e[(r = o[i])]) &&
                ((n = !0), "_listeners" === r || x(t) || delete e[r]);
            return n;
          }
          function I(e, t, r) {
          ...
          function E(e, t, r) {
            ...
            if (n || a || i) {
              var c = t,
                d = t._origin || t;
              if (a && !s) throw Error("process.nextTick is not supported");
          ...
          (I.prototype.off = function () {
            ...
            (A.EventEmitter2 = A),
            (A.prototype.listenTo = function (e, t, r) {
              if ("object" != typeof e)
              ...
              function i(t) {
                ...
                var o,
                  i = r.reducers,
                  a = O.call(n, e);
                o = -1 === a ? new b(n, e, r) : n._observers[a];
                for (
                  var s,
                    u = d(t),
                    c = u.length,
                  ...
                  (s = u[f]), o.subscribe(s, t[s] || s, l ? i : i && i[s]);
              }
              return (
                (r = h(
                  r,
                  { on: o, off: o, reducers: o },
                  { on: P, off: P, reducers: M }
                )),
                a(t)
                  ? i(y(t))
            ...
            (A.prototype._many = function (e, t, r, n, o) {
              ...
              function a() {
                return 0 == --t && i.off(e, a), r.apply(this, arguments);
              }
              return (a._origin = r), this._on(e, a, n, o);
            }),
            (A.prototype.emit = function () {
              ...
              if (s) (c = []), j.call(this, c, e, this.listenerTree, 0, r);
              else {
              ...
              if (this._all)
                for (o = 0, n = this._all.length; o < n; o++)
                  switch (((this.event = a), d)) {
                    ...
                    case 3:
                      l.push(
                        this._all[o].call(this, a, arguments[1], arguments[2])
                      );
                      break;
                    default:
            ...
            (A.prototype._onAny = function (e, t) {
              if ("function" != typeof e)
            ...
            (A.prototype._on = function (e, t, r, n) {
              ...
              var i,
                a = this;
              return (
                n !== o && ((t = (i = E.call(this, e, t, n))[0]), (a = i[1])),
            ...
            (A.prototype.off = function (e, t) {
              ...
              for (var i = 0; i < n.length; i++) {
                ...
                (r === t ||
                  ...
                  (this.wildcard ? delete s._listeners : delete this._events[e],
                  this._removeListener && this.emit("removeListener", e, t));
              }
            ...
            (A.prototype.eventNames = function (e) {
              ...
              return this.wildcard
                ? C.call(this, this.listenerTree, [], null, e)
                : t
                ? d(t)
                : [];
            }),
                ...
                if (0 === i.compressedSize) {
                  ...
                  for (; a < 0 && e.position < e.fileInfo.size; )
                    await e.peekBuffer(t, { mayBeLess: !0 }),
                      (a = t.indexOf("504B0304", 0, "hex")),
                      await e.ignore(a >= 0 ? a : t.length);
              ...
              t = Math.abs(t),
                isNaN(t) || t === 1 / 0
                  ...
                  : ((a = Math.floor(Math.log(t) / Math.LN2)),
                    ...
                    (t += a + d >= 1 ? f / u : f * Math.pow(2, 1 - d)) * u >=
                      2 && (a++, (u /= 2)),
                    a + d >= l
                      ? ((s = 0), (a = l))
                      : a + d >= 1
                      ...
                      : ((s = t * Math.pow(2, d - 1) * Math.pow(2, o)),
                        (a = 0)));
              o >= 8;
              e[r + p] = 255 & s, p += g, s /= 256, o -= 8
            );
            for (
              a = (a << o) | s, c += o;
              c > 0;
              e[r + p] = 255 & a, p += g, a /= 256, c -= 8
            );
            e[r + p - g] |= 128 * m;
          });
      },
      ...
      91456: (e, t, r) => {
        ...
        (t.FileTokenizer = a),
          (t.fromFile = async function (e) {
            ...
            return new a(r, { path: e, size: t.size });
          });
      },
      91343: (e, t, r) => {
        "use strict";
      ...
      44266: (e, t, r) => {
        ...
        class a {
          ...
          static decode(e, t, r) {
            let n = "";
            for (let o = t; o < r; ++o)
              n += a.codePointToString(a.singleByteDecoder(e[o]));
            return n;
          }
          ...
          static singleByteDecoder(e) {
            if (a.inRange(e, 0, 127)) return e;
            const t = a.windows1252[e - 128];
            if (null === t) throw Error("invaliding encoding");
            return t;
          }
          get(e, t = 0) {
            return a.decode(e, t, t + this.len);
          }
        }
        (t.AnsiStringType = a),
          (a.windows1252 = [
      ...
      63539: function (e, t, r) {
        ...
        s.onInjected(() => {
          u.BlocklistStore.on("sort", () => {
            a.internalEv.emit("blocklist.sync");
          });
        });
      },
      86671: (e, t, r) => {
      ...
      7937: function (e, t, r) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.blockContact = async function (e) {
            ...
            (0, a.compare)(c.SANITIZED_VERSION_STR, "2.2323.4", ">=")
            ...
            return { wid: t, isBlocked: (0, d.isBlocked)(t) };
          });
        const a = r(38385),
          s = r(41687),
          u = r(14647),
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.unblockContact = async function (e) {
            const t = (0, a.assertWid)(e),
              r = s.ContactStore.get(t) || new s.ContactModel({ id: t });
            return (
        ...
        s.onInjected(
          () => (
            u.CallStore.on("add", (e) => {
              e.isGroup &&
                a.internalEv.emit("call.incoming_call", {
                  id: e.id,
                  isGroup: e.isGroup,
                  isVideo: e.isVideo,
      ...
      21139: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.accept = async function (e) {
            ...
            return await o.websocket.sendSmaxStanza(a), !0;
          });
        const n = r(62857),
          o = r(14647),
          i = r(20514);
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.parseRelayResponse = function (e) {
            const t = o(e.content.find((e) => "rte" === e.tag).content),
              ...
              a = new TextDecoder().decode(new Uint8Array(i.content)),
              s = {};
            r.content
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.prepareDestionation = async function (e, t) {
            ...
            const i = await Promise.all(
              ...
              a = [];
            if ((a.push(n.websocket.smax("destination", {}, i)), o)) {
            ...
            for (const r of t) {
              ...
              if (t) {
                const n = new i.ProductModel({
                  ...
                  maxAvailable: null == t ? void 0 : t.maxAvailable,
                  reviewStatus:
                    null == t ? void 0 : t.capability_to_review_status[0].value,
                  currency: t.currency,
                  priceAmount1000: t.price,
                  salePriceAmount1000: null,
                  retailerId: t.retailer_id,
                  imageCount:
                    t.image_cdn_urls.length +
                    t.additional_image_cdn_urls.length,
                  additionalImageCdnUrl: t.additional_image_cdn_urls,
                  additionalImageHashes: t.image_hashes_for_whatsapp,
                  imageCdnUrl: t.image_cdn_urls[0].value,
                  imageHash: t.image_hashes_for_whatsapp[0],
                });
                await (0, a.addProductToCart)(n),
                  await (0, a.updateProductQuantityCart)(n, r.qnt);
              }
            }
      ...
      70932: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.clear = async function (e) {
            var t, r;
            const a = o.CartStore.findCart(e);
            if (
              !a ||
              !(null === (t = null == a ? void 0 : a.cartItemCollection) ||
              void 0 === t
                ? void 0
                : t.length)
            )
            ...
            null === (r = a.cartItemCollection) || void 0 === r || r.reset(),
              a.set("message", ""),
      ...
      65731: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getThumbFromCart = async function (e) {
            var t, r;
            const i = await o.CartStore.findCart(e),
              a =
                null === (t = null == i ? void 0 : i.cartItemCollection) ||
                void 0 === t
                  ? void 0
                  : t.at(0);
            if (!a || !i) return "";
            const s = o.CatalogStore.get((0, n.createWid)(e));
            if (!s) return "";
            const u = s.productCollection.get(a.id);
            if (!u) return "";
            const c = await (null == u
              ? void 0
              : u.getProductImageCollectionHead());
            if (!c) return "";
            const l = null == c ? void 0 : c.mediaData;
            if (null == l) return "";
            if (l.preview) {
              const e = await (null === (r = null == l ? void 0 : l.preview) ||
              void 0 === r
                ? void 0
                : r.getBase64());
              if (null != e) return e;
      ...
      89133: (e, t, r) => {
        ...
        var a = r(65731);
        Object.defineProperty(t, "getThumbFromCart", {
          enumerable: !0,
          get: function () {
        ...
        var u = r(24393);
        Object.defineProperty(t, "submit", {
          enumerable: !0,
          get: function () {
            return u.submit;
          },
      ...
      74553: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.remove = async function (e, t) {
            ...
            return (
              await (0, i.deleteProductFromCart)(e, t), o.CartStore.findCart(e)
            );
          });
        const n = r(62857),
          o = r(14647),
      ...
      24393: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.submit = async function (e, t, r) {
            var c, l, d;
            if (
              e.toString() ==
              (null === (c = (0, o.getMyUserId)()) || void 0 === c
                ? void 0
                : c.toString())
            )
            ...
            const f = a.CartStore.findCart(e);
            if (
              !f ||
              !(null === (l = null == f ? void 0 : f.cartItemCollection) ||
              void 0 === l
                ? void 0
                : l.length)
            )
            ...
            const p = await (0, s.findChat)((0, i.createWid)(e)),
              g = await (0, s.createOrder)(
                p.id,
                f.cartItemCollection.toArray()
              ),
              m = null === (d = g.price) || void 0 === d ? void 0 : d.total,
              y = await (0, n.prepareRawMessage)(
                p,
                {
                  type: "order",
                  orderId: g.id,
                  token: g.token,
                  orderTitle: p.name || p.formattedTitle,
                  sellerJid: p.id.toString({ legacy: !0 }),
                  status: 1,
                  messageVersion: 2,
                  thumbnail: await (0, u.getThumbFromCart)(e),
                  itemCount: f.itemCount,
                  message: t || f.message,
                  totalAmount1000: m && m.length > 0 ? parseInt(m, 10) : void 0,
                  totalCurrencyCode:
                    g.price.currency && g.price.currency.length > 0
                      ? g.price.currency
                      : 0,
                },
                r
            ...
            if (
              (await (0, s.addAndSendMsgToChat)(p, y),
              (0, s.updateCart)(f),
              await (0, u.clear)(e),
              !g.id)
            )
            ...
            return await (0, n.getMessageById)(y.id);
          });
        const n = r(74023),
          o = r(72927),
          i = r(62857),
      ...
      57288: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.update = async function (e, t, r) {
            if (!e || !t || !r.quantity)
              throw new n.WPPError(
                "send_required_params",
                "For update item in cart send chatId, productId and options"
              );
            return (0, o.add)(e, [{ id: t, qnt: r.quantity }]);
          });
        const n = r(62857),
          o = r(71722);
      },
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.addProductImage = async function (e, t) {
            const r = await (0, o.convertToFile)(t),
              s = await i.OpaqueData.createFromData(r, r.type),
              u = await (0, a.calculateFilehashFromBlob)(r),
              c = await (0, a.uploadProductImage)(s, u),
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.createProduct = async function (e) {
            const t = await (0, n.convertToFile)(e.image),
              ...
              a = await (0, i.calculateFilehashFromBlob)(t),
              s = await (0, i.uploadProductImage)(r, a),
      ...
      70510: function (e, t, r) {
        ...
        s.onFullReady(function () {
          function e(e) {
            ...
            a.internalEv.emit("chat.msg_ack_change", {
              ack: e.ack,
              chat: t,
              sender: r,
              ids: i,
      ...
      16854: function (e, t, r) {
        ...
        const a = r(13691),
          ...
          u = r(14647);
        s.onInjected(() => {
          u.ChatStore.on("change:active", (e) => {
            c && clearTimeout(c),
              (c = setTimeout(() => {
                a.internalEv.emit("chat.active_chat", e.active ? e : null);
              }, 50));
          });
        });
        let c = null;
      ...
      56136: function (e, t, r) {
        ...
        s.onFullReady(function () {
          u.MsgStore.on("change:latestEditMsgKey", (e) => {
            queueMicrotask(() => {
              a.internalEv.emit("chat.msg_edited", {
                chat: e.to,
                id: e.id.toString(),
                msg: e,
              });
        ...
        c.onFullReady(function () {
          async function e(e, ...t) {
            ...
            if ((0, a.isMainReady)()) {
              ...
              s.internalEv.emit("chat.update_label", {
                chat: (0, f.get)(o),
                ids: n,
                labels: t,
                type: e,
          ...
          (function () {
                  ...
                  "ciphertext" ===
                    (e = await (async function (e) {
                      if (void 0 !== e.quotedStanzaID) {
                        const t = (0, c.getQuotedMsgObj)(e);
                        if (!t) return e;
                        Object.defineProperties(e, {
                          _quotedMsgObj: { value: t, writable: !1 },
                          quotedMsgId: { value: t.id, writable: !1 },
                        });
                      }
                      return e;
                    })(e)).type &&
            ...
            void 0 === u.MsgModel.prototype.quotedMsgId &&
              Object.defineProperty(u.MsgModel.prototype, "quotedMsgId", {
                get: function () {
                  return (0, l.getQuotedMsgKey)(this);
                },
                configurable: !0,
              });
          })()
            ...
            o.PresenceStore.on("change:chatstate.type", (e) => {
              ...
              r &&
                ...
                queueMicrotask(() => {
                  ...
                  r.isUser &&
                    (a.isContact = !(null === (t = r.chatstate) || void 0 === t
                      ? void 0
                      : t.deny)),
                    r.isGroup &&
                      (a.participants = r.chatstates
                        .getModelsArray()
                        .filter((e) => !!e.type)
                        .map((e) => {
          ...
          (0, l.wrapModuleFunction)(d.createOrUpdateReactions, (e, ...t) => {
            ...
            if (Array.isArray(r))
              for (const e of r)
                try {
                  if (e.t < n) continue;
                  a.internalEv.emitAsync("chat.new_reaction", {
                    id: c.MsgKey.fromString(e.id),
                    orphan: e.orphan,
                    orphanReason: e.orphanReason,
                    msgId: c.MsgKey.fromString(e.reactionParentKey),
                    reactionText: e.reactionText,
                    read: e.read,
                    sender: (0, s.createWid)(e.from),
                    timestamp: e.t,
                  });
                } catch (e) {}
            else
              try {
                if (t[1]) {
                  if (f[r.msgKey]) return e(...t);
                  (f[r.msgKey] = r),
                    a.internalEv.emitAsync("chat.new_reaction", {
                      id: c.MsgKey.fromString(r.msgKey),
                      orphan: r.orphan,
                      orphanReason: null,
                      msgId: c.MsgKey.fromString(r.parentMsgKey),
                      reactionText: r.reactionText,
                      read: r.read,
                      sender: (0, s.createWid)(r.senderUserJid),
                      timestamp: r.t,
                    }),
                    setTimeout(() => {
                      delete f[r.msgKey];
          ...
          (function () {
            ...
            u.MsgStore.processMultipleMessages = (r, n, ...o) =>
              new Promise((i, s) => {
                try {
                  for (const e of n)
                    e.isNewMsg &&
                      ...
                      a.internalEv.emit("chat.msg_revoke", {
                        author: e.author,
                        from: e.from,
                        id: e.id,
                ...
                e.call(u.MsgStore, r, n, ...o).then(i, s);
              });
          })()
        );
      },
      95071: (e, t, r) => {
        ...
        async function u(e, t = !0) {
          const r = (0, o.assertWid)(e),
            u = (0, o.assertGetChat)(r);
          if (u.archive === t)
            throw new i.WPPError(
          ...
          return (
            (0, n.compare)(self.Debug.VERSION, "2.3000.0", ">=")
              ? a.Cmd.archiveChat(u, t)
              : await (0, s.setArchive)(u, t),
            { wid: r, archive: t }
          );
        }
      },
      15035: (e, t) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.encryptAndParserMsgButtons = async function (e, t, r, n, o, i, a) {
            var s, u;
            ...
            if (
              null ===
                (u =
                  null === (s = null == t ? void 0 : t.viewOnceMessage) ||
                  void 0 === s
                    ? void 0
                    : s.message) || void 0 === u
                ? void 0
              ...
              const s = (function (e, t) {
                ...
                const d = t.filter((e) => !e.device),
                  f = t.filter((e) => e.device),
                  p =
                    null ===
                      (n =
                        null === (r = e.viewOnceMessage) || void 0 === r
                          ? void 0
                          : r.message) || void 0 === n
                      ? void 0
                ...
                if (p) {
                        ...
                        buttonsMessage: Object.assign(
                          Object.assign(
                            {
                              headerType: n,
                              contentText:
                                (null === (o = null == p ? void 0 : p.body) ||
                                void 0 === o
                                  ? void 0
                                  : o.text) || " ",
                              footerText:
                                (null === (i = null == p ? void 0 : p.footer) ||
                                void 0 === i
                                  ? void 0
                                  : i.text) || " ",
                            },
                          ...
                          ),
                          {
                            buttons:
                              null ===
                                (a =
                                  null == p ? void 0 : p.nativeFlowMessage) ||
                              void 0 === a
                                ? void 0
                                : a.buttons
                                    .map((e, t) => {
                                      var r, n;
                                      return "quick_reply" == e.name
                                        ? {
                                            type: 1,
                                            buttonId:
                                              (null ===
                      ...
                      message: {
                        templateMessage: {
                          hydratedTemplate: Object.assign(
                            ...
                            {
                              hydratedContentText:
                                (null === (c = null == p ? void 0 : p.body) ||
                                void 0 === c
                                  ? void 0
                                  : c.text) || " ",
                              hydratedFooterText:
                                (null === (l = null == p ? void 0 : p.footer) ||
                                void 0 === l
                                  ? void 0
                                  : l.text) || " ",
                            }
                  ...
                  delete m.viewOnceMessage,
                    (m.documentWithCaptionMessage = g ? f : d),
                    (m.messageContextInfo = e.messageContextInfo);
                }
                return [
                  { proto: e, devices: d },
                  { proto: m, devices: f },
              ...
              s.map(async (t) => {
                ...
                c.push(...r.stanza.content[0].content);
              });
            }
            const l = await a(
              e,
      ...
      99459: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.closeChat = async function () {
            const e = (0, o.getActiveChat)();
            return !!e && (n.Cmd.closeChat(e), !0);
          });
        const n = r(14647),
          o = r(97829);
      },
      ...
      74931: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.deleteMessage = async function (e, t, r = !1, c = !1) {
            const l = (0, o.assertGetChat)(e);
            let d = !1;
            Array.isArray(t) || ((d = !0), (t = [t]));
            const f = await (0, u.getMessageById)(t),
              p = [];
            for (const t of f) {
              let o = s.SendMsgResult.ERROR_UNKNOWN,
                u = !1,
                d = !1;
              const f = t.senderObj.isMe;
              let g = !1;
              l.isGroup && (g = await (0, i.iAmAdmin)(e));
              const m = f || g;
              t.type === s.MSG_TYPE.REVOKED && c
                ? ((o = s.SendMsgResult.ERROR_UNKNOWN), (u = !0))
                : c && m
                ? ("list" === t.type && (t.__x_isUserCreatedType = !0),
                  (0, n.compare)(self.Debug.VERSION, "2.3000.0", ">=")
                    ? await a.Cmd.sendRevokeMsgs(
                        l,
                        { type: "message", list: [t] },
                        { clearMedia: r }
                      )
                    : await a.Cmd.sendRevokeMsgs(l, [t], { clearMedia: r }),
                  (o = s.SendMsgResult.OK),
                  (u = !0))
                : ((0, n.compare)(self.Debug.VERSION, "2.3000.0", ">=")
                    ? await a.Cmd.sendDeleteMsgs(
                        l,
                        { type: "message", list: [t] },
                        r
                      )
                    : await a.Cmd.sendDeleteMsgs(l, [t], { clearMedia: r }),
                  (o = s.SendMsgResult.OK),
                  (d = !l.msgs.get(t.id))),
                p.push({
                  id: t.id.toString(),
      ...
      48157: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.downloadMedia = async function e(t) {
            var r;
            const a = await (0, i.getMessageById)(t);
            if (!a.mediaData)
              throw new n.WPPError(
            ...
            await a.downloadMedia({
              downloadEvenIfExpensive: !0,
              rmrReason: 1,
              isUserInitiated: !0,
            });
            let s = null;
            a.mediaData.filehash &&
              (s = o.MediaBlobCache.get(a.mediaData.filehash));
            !s &&
              a.mediaData.mediaBlob &&
              (s = a.mediaData.mediaBlob.forceToBlob());
            if (
              !s &&
              "VIDEO" ===
                (null === (r = a.mediaObject) || void 0 === r ? void 0 : r.type)
            )
              try {
                return (
                  (a.type = "document"),
                  (a.mediaObject.type = "DOCUMENT"),
                  await e(t)
                );
              } finally {
      ...
      35090: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.editMessage = async function (e, t, r = {}) {
            ...
            const u = await (0, a.getMessageById)(e),
              c = (0, o.canEditMsg)(u),
              l = (0, o.canEditCaption)(u);
            if (!c && !l)
              throw new n.WPPError(
                "edit_message_error",
            ...
            return (
              (d = await (0, a.prepareRawMessage)(u.chat, d, r)),
              (d.latestEditMsgKey = d.id),
              (d.latestEditSenderTimestampMs = d.t),
              await (0, a.sendRawMessage)(
                null === (s = u.chat) || void 0 === s ? void 0 : s.id,
                d,
                r
              )
            );
      ...
      36618: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.find = async function (e) {
            ...
            r.isGroup && (await o.GroupMetadataStore.find(r.id));
            return r;
          });
        const n = r(41687),
          o = r(14647),
      ...
      74997: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.forwardMessage = async function (e, t, r = {}) {
            const a = await (0, n.assertFindChat)(e),
          ...
          (t.generateMessageID = async function (e) {
            ...
            r =
              e instanceof o.Wid
                ...
                : (0, n.assertWid)(e);
            let a;
            r.isGroup() && (a = o.WidFactory.toUserWid(t));
            return new o.MsgKey({
              from: t,
              to: r,
      ...
      73546: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getLastSeen = async function (e) {
            ...
            return r.presence.chatstate.t || !1;
          });
        const n = r(41687),
          o = r(14647);
      },
      17181: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getMessageACK = async function (e) {
            ...
            return (
              null == r || r.delivery.forEach((e) => a(e, "deliveredAt")),
              null == r || r.read.forEach((e) => a(e, "readAt")),
              null == r || r.played.forEach((e) => a(e, "playedAt")),
              {
                ack: t.ack,
                fromMe: t.id.fromMe,
                deliveryRemaining:
      ...
      17530: function (e, t, r) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getMessageById = async function (e) {
            var t, r, n, o;
            let l = !1;
            Array.isArray(e) || ((l = !0), (e = [e]));
            const d = e.map((e) => s.MsgKey.fromString(e.toString()));
            let f = [];
            for (const e of d) {
              let l = s.MsgStore.get(e);
              const d =
                "function" ==
                typeof (null === (t = e.remote) || void 0 === t
                  ? void 0
                  : t.isStatusV3)
                  ? null === (r = e.remote) || void 0 === r
                    ? void 0
                    : r.isStatusV3()
                  : null ===
                      (o =
                        null === (n = e.remote) || void 0 === n
                          ? void 0
                          : n.toString()) || void 0 === o
                  ? void 0
                  : o.includes("status@broadcast");
              if (!l)
                if (d) l = s.StatusV3Store.getMyStatus().msgs.get(e);
                else {
                  const t = (0, i.assertGetChat)(e.remote);
                  if (((l = t.msgs.get(e)), !l)) {
                    c(`searching remote message with id ${e.toString()}`);
                    const r = (0, u.getSearchContext)(t, e);
                    await r.collection.loadAroundPromise,
                      (l = t.msgs.get(e) || r.collection.get(e));
                  }
                }
              if (!l)
                throw (
            ...
            if (
              ((f = f.map((e) =>
                e instanceof s.MsgModel
                  ? e
                  : s.MsgStore.get(e) || new s.MsgModel(e)
              )),
              l)
            )
              return f[0];
      ...
      48769: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getMessages = async function (e, t = {}) {
            var r;
            const s = (0, n.assertGetChat)(e);
            let u = t.count || 20;
            const c = "after" === t.direction ? "after" : "before",
              l =
                t.id ||
                (null === (r = s.lastReceivedKey) || void 0 === r
                  ? void 0
                  : r.toString());
            if (t.onlyUnread) {
              if (!s.hasUnread) return [];
              const e = s.unreadCount < 0 ? 2 : s.unreadCount;
              u = u < 0 ? e : Math.min(u, e);
            }
            -1 === u && (0, o.isMultiDevice)() && (u = 1 / 0);
            !t.id && l && u--;
            const d = l ? i.MsgKey.fromString(l) : { remote: s.id };
            ...
            if ("all" === t.media) {
              ...
              void 0 !== t.media
                ? ((d.media = t.media),
                  (f = await (0, a.msgFindQuery)("media", d)))
                : (f = await (0, a.msgFindQuery)(c, d));
            if (!t.id && l) {
          ...
          (t.getNotes = async function (e) {
            ...
            if (t.isGroup)
              throw new i.WPPError(
                ...
                `You can not get notes for groups. ChatId: ${e}`
              );
            return await (0, a.retrieveOnlyNoteForChatJid)(t.id.toJid());
          });
        const n = r(41687),
          o = r(5882),
          i = r(62857),
      ...
      55595: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getPlatformFromMessage = function (e) {
            ...
            if (t.id.length > 21) return "android";
            if (t.id.startsWith("3A")) return "iphone";
            if (t.id.startsWith("3EB0")) return "web";
            return "unknown";
          });
        const n = r(14647);
      },
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getQuotedMsgKey = function (e) {
            ...
            const r = e.quotedRemoteJid ? e.quotedRemoteJid : e.id.remote,
              ...
              s =
                "function" == typeof i.Wid.isStatusV3
                  ? i.Wid.isStatusV3(r)
                  : i.Wid.isStatus(r);
            return new i.MsgKey({
              id: e.quotedStanzaID,
              ...
              remote: r,
              participant:
                i.Wid.isGroup(e.from) || i.Wid.isGroup(e.to) || s
                  ? e.quotedParticipant
                  : void 0,
            });
          });
      ...
      97829: (e, t, r) => {
        ...
        var u = r(99459);
        Object.defineProperty(t, "closeChat", {
          enumerable: !0,
          get: function () {
            return u.closeChat;
          },
        ...
        var M = r(91520);
        Object.defineProperty(t, "getNotes", {
          enumerable: !0,
          get: function () {
            return M.getNotes;
          },
        ...
        var W = r(6993);
        Object.defineProperty(t, "pinMsg", {
          enumerable: !0,
          get: function () {
            return W.pinMsg;
          },
        }),
          Object.defineProperty(t, "unpinMsg", {
            enumerable: !0,
            get: function () {
              return W.unpinMsg;
            },
        ...
        Object.defineProperty(t, "prepareMessageButtons", {
          enumerable: !0,
          get: function () {
            return q.prepareMessageButtons;
          },
        });
        var z = r(19211);
        ...
        var V = r(82028);
        Object.defineProperty(t, "sendChargeMessage", {
          enumerable: !0,
          get: function () {
            return V.sendChargeMessage;
          },
        });
        var K = r(68011);
        Object.defineProperty(t, "sendCreatePollMessage", {
          enumerable: !0,
          get: function () {
            return K.sendCreatePollMessage;
          },
        });
        var J = r(35824);
        Object.defineProperty(t, "sendEventMessage", {
          enumerable: !0,
          get: function () {
            return J.sendEventMessage;
          },
        });
        var H = r(24654);
        ...
        Object.defineProperty(t, "sendGroupInviteMessage", {
          enumerable: !0,
          get: function () {
            return Q.sendGroupInviteMessage;
          },
        });
        var Y = r(35184);
        ...
        var X = r(42992);
        Object.defineProperty(t, "sendPixKeyMessage", {
          enumerable: !0,
          get: function () {
            return X.sendPixKeyMessage;
          },
        });
        var ee = r(44190);
        ...
        Object.defineProperty(t, "sendReactionToMessage", {
          enumerable: !0,
          get: function () {
            return te.sendReactionToMessage;
          },
        });
        var re = r(59633);
        Object.defineProperty(t, "sendScheduledCallMessage", {
          enumerable: !0,
          get: function () {
            return re.sendScheduledCallMessage;
          },
        });
        var ne = r(68533);
        ...
        Object.defineProperty(t, "sendVCardContactMessage", {
          enumerable: !0,
          get: function () {
            return oe.sendVCardContactMessage;
          },
        });
        var ie = r(43859);
        Object.defineProperty(t, "setChatList", {
          enumerable: !0,
          get: function () {
            return ie.setChatList;
          },
        });
        var ae = r(18194);
        Object.defineProperty(t, "setInputText", {
          enumerable: !0,
          get: function () {
            return ae.setInputText;
          },
        });
        var se = r(31116);
        Object.defineProperty(t, "setNotes", {
          enumerable: !0,
          get: function () {
            return se.setNotes;
          },
      ...
      33985: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.keepMessage = async function (e, t = !0) {
            const r = await (0, s.getMessageById)(e);
            if (await (0, n.iAmAdmin)(r.id.remote)) {
              if (r.isExpired())
                throw new o.WPPError("msg_expired", "This message has expired");
              return t
                ? (await (0, a.keepMessage)(r, i.KIC_ENTRY_POINT_TYPE.CHAT),
                  await (0, s.getMessageById)(e))
                : (await (0, a.undoKeepMessage)(
                    r,
                    { deleteExpired: !0 },
      ...
      88241: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.list = async function (e = {}) {
            ...
            let i = e.onlyNewsletter
              ? n.NewsletterStore.getModelsArray().slice()
              : n.ChatStore.getModelsArray().slice();
            ...
            const a = (null == e ? void 0 : e.id) ? (0, o.get)(e.id) : null,
              s = a ? i.indexOf(a) : 0;
            if ("before" === r) {
              const e = s - t < 0 ? 0 : s - t,
                r = e + t >= s ? s : e + t;
              i = i.slice(e, r);
            } else i = i.slice(s, s + t);
            for (const e of i)
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.mute = async function (e, t) {
            ...
            return (
              ...
              {
                wid: r,
                expiration: a.mute.expiration,
                isMuted: 0 !== a.mute.expiration,
              }
            );
          });
        const n = r(41687),
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.openChatAt = async function (e, t) {
            const r = (0, n.assertWid)(e),
              ...
              u = await (0, a.getMessageById)(t),
              c = (0, i.getSearchContext)(s, u);
            return await o.Cmd.openChatAt(s, c);
          });
        const n = r(41687),
          o = r(14647),
          i = r(52757),
      ...
      61278: (e, t, r) => {
        ...
        async function a(e, t = !0) {
          ...
          return await (0, i.setPin)(a, t), { wid: r, pin: t };
        }
      },
      6993: (e, t, r) => {
        "use strict";
        ...
        const n = r(41687),
          ...
          s = r(52757),
          u = r(17530);
        async function c(e, t = !0, r = 604800) {
          var c, l, d, f, p;
          const g = await (0, u.getMessageById)(e),
            m = (0, n.assertGetChat)(g.id.remote),
            y = i.PinInChatStore.getByParentMsgKey(g.id);
          if (m.isNewsletter)
            throw new o.WPPError(
              (t ? "pin" : "unpin") + "_error",
              `The msg ${e.toString()} was not pinned. Not can pin in Newsletter`,
              { msgId: e, pin: t }
            );
          if (
            m.isGroup &&
            !(null ===
              (l =
                null === (c = m.groupMetadata) || void 0 === c
                  ? void 0
                  : c.participants) || void 0 === l
              ? void 0
              : l.iAmMember())
          )
            throw new o.WPPError(
              (t ? "pin" : "unpin") + "_error",
              `You not a member of group, to pin msg ${e.toString()}`,
              { msgId: e, pin: t }
            );
          if (
            m.isGroup &&
            ((null === (d = m.groupMetadata) || void 0 === d
              ? void 0
              : d.restrict) ||
              (null === (f = m.groupMetadata) || void 0 === f
                ? void 0
                : f.announce)) &&
            ...
            throw new o.WPPError(
              (t ? "pin" : "unpin") + "_error",
              `You not have permission to pin msg ${e.toString()}`,
              { msgId: e, pin: t }
            );
          if (
            g.isNotification ||
            g.isViewOnce ||
            g.type === a.MSG_TYPE.REVOKED ||
            ((null == g ? void 0 : g.ack) || 0) < a.ACK.SENT
          )
            throw new o.WPPError(
              (t ? "pin" : "unpin") + "_error",
              `The msg ${e.toString()} not can be pinned`,
              { msgId: e, pin: t }
            );
          if (y && y.pinType === (t ? a.PIN_STATE.PIN : a.PIN_STATE.UNPIN))
            throw new o.WPPError(
              (t ? "pin" : "unpin") + "_error",
              `The msg ${e.toString()} is already ${t ? "pinned" : "unpinned"}`,
              { msgId: e, pin: t }
            );
          const b = await (0, s.sendPinInChatMsg)(
            g,
            1 == t ? a.PIN_STATE.PIN : a.PIN_STATE.UNPIN,
            t ? r : void 0
          );
          return {
            message: g,
            pinned: b.messageSendResult === a.SendMsgResult.OK ? t : !t,
            result: b.messageSendResult,
          };
        }
      },
          ...
          (t.prepareAudioWaveform = async function (e, t) {
            ...
            try {
              const e = await t.arrayBuffer(),
                ...
                i = 64,
                a = Math.floor(o.length / i),
                s = [];
              for (let e = 0; e < i; e++) {
                const t = a * e;
                let r = 0;
                for (let e = 0; e < a; e++) r += Math.abs(o[t + e]);
                s.push(r / a);
              }
              ...
              async (e, ...t) => {
                ...
                return new Promise(async (r) => {
                  try {
                    ...
                    let i = {};
                    t &&
                      (i = await (0, s.generateThumbnailLinkPreviewData)(
                        t
                      ).catch(() => null));
          ...
          (t.prepareMessageButtons = function (e, t) {
            ...
            return (
              ...
              (e.interactiveMessage = {
                header: { title: t.title || " ", hasMediaAttachment: !1 },
                body: { text: e.body || e.caption || " " },
                footer: { text: t.footer || " " },
                nativeFlowMessage: {
                  buttons: t.buttons.map((e, t) =>
                    "phoneNumber" in e
                      ? {
                          name: "cta_call",
              ...
              (e.isFromTemplate = !0),
              (e.buttons = new u.TemplateButtonCollection()),
              (e.hydratedButtons = t.buttons.map((e, t) =>
                "phoneNumber" in e
                  ...
                  ? {
                      ...
                      urlButton: {
                        displayText: e.text,
                        url: `https://www.whatsapp.com/otp/code/?otp_type=COPY_CODE&code=otp${e.code}`,
                      },
                    }
                  : {
                      index: t,
              ...
              e.buttons.add(
                e.hydratedButtons.map((e, t) => {
                  var r, n, o, i;
                  const a = `${null != e.index ? e.index : t}`;
                  return e.urlButton
                    ? new u.TemplateButtonModel({
                        id: a,
                        displayText:
        ...
        s.onFullReady(() => {
          (0, l.wrapModuleFunction)(d.createMsgProtobuf, (e, ...t) => {
            ...
            if (
              ...
              (null ===
                (n =
                  null === (r = a.interactiveMessage) || void 0 === r
                    ? void 0
                    : r.nativeFlowMessage) || void 0 === n
                ? void 0
                : n.buttons)
            ) {
              const e = [
              ...
              for (let t of e)
                if (t in s) {
                  const e = t;
                  "documentWithCaptionMessage" === t && (t = "documentMessage"),
                    (a.interactiveMessage.header = Object.assign(
                      Object.assign({}, a.interactiveMessage.header),
                      {
                        [`${t}`]:
                          (null ===
                            (i =
              ...
              void 0 !== s.extendedTextMessage && delete s.extendedTextMessage,
                void 0 !== s.conversation && delete s.conversation,
                (s.viewOnceMessage = {
                  message: { interactiveMessage: a.interactiveMessage },
                });
            }
            return s;
          }),
            (0, l.wrapModuleFunction)(d.encodeMaybeMediaType, (e, ...t) => {
              const [r] = t;
              return "button" === r ? c.DROP_ATTR : e(...t);
            }),
            (0, l.wrapModuleFunction)(d.mediaTypeFromProtobuf, (e, ...t) => {
              var r, n, o, i, a, s;
              const [u] = t;
              return (
                null ===
                  (o =
                    null ===
                      (n =
                        null === (r = u.documentWithCaptionMessage) ||
                        void 0 === r
                          ? void 0
                          : r.message) || void 0 === n
                      ? void 0
                      : n.templateMessage) || void 0 === o
                  ? void 0
                  : o.hydratedTemplate
              )
                ? e(
                    null ===
                      (s =
                        null ===
                          (a =
                            null === (i = u.documentWithCaptionMessage) ||
                            void 0 === i
                              ? void 0
                              : i.message) || void 0 === a
                          ? void 0
                          : a.templateMessage) || void 0 === s
                      ? void 0
                      : s.hydratedTemplate
                  )
                : e(...t);
            ...
            (0, l.wrapModuleFunction)(
              d.typeAttributeFromProtobuf,
              (e, ...t) => {
                var r, n, o, i, a, s, u, c, l, d;
                const [f] = t;
                if (
                  null === (r = null == f ? void 0 : f.viewOnceMessage) ||
                  void 0 === r
                    ? void 0
                    : r.interactiveMessage
                ) {
                  const e = Object.keys(
                    null === (n = null == f ? void 0 : f.viewOnceMessage) ||
                      void 0 === n
                      ? void 0
                      : n.interactiveMessage
                  );
                        ...
                        (i =
                          null ===
                            (o =
                              null == f
                                ? void 0
                                : f.documentWithCaptionMessage) || void 0 === o
                            ? void 0
                            : o.message) || void 0 === i
                        ? void 0
                        : i.templateMessage) || void 0 === a
                    ? void 0
                    : a.hydratedTemplate
                ) {
                  const e = Object.keys(
                          ...
                          (u =
                            null ===
                              (s =
                                null == f
                                  ? void 0
                                  : f.documentWithCaptionMessage) ||
                            void 0 === s
                              ? void 0
                              : s.message) || void 0 === u
                          ? void 0
                          : u.templateMessage) || void 0 === c
                      ? void 0
                      : c.hydratedTemplate
                  );
                  return [
                ...
                return 1 ===
                  (null === (l = null == f ? void 0 : f.buttonsMessage) ||
                  void 0 === l
                    ? void 0
                    : l.headerType) ||
                  2 ===
                    (null === (d = null == f ? void 0 : f.buttonsMessage) ||
                    void 0 === d
                      ? void 0
                      : d.headerType)
                  ? "text"
            ...
            (0, l.wrapModuleFunction)(
              d.createFanoutMsgStanza,
              async (e, ...t) => {
                var r, n;
                let o = null;
                const i = t[1].id ? t[2] : t[1];
                if (i.buttonsMessage) o = u.websocket.smax("buttons");
                else if (i.listMessage) {
                  const e = 2,
                    t = ["unknown", "single_select", "product_list"];
                  o = u.websocket.smax("list", { v: "2", type: t[e] });
                }
                let a = await e(...t);
                if (
                  ((null ===
                    (n =
                      null === (r = null == i ? void 0 : i.viewOnceMessage) ||
                      void 0 === r
                        ? void 0
                        : r.message) || void 0 === n
                    ? void 0
                    : n.interactiveMessage) &&
                    (a = await (0, f.encryptAndParserMsgButtons)(...t, e)),
                  !o)
                )
                  return a;
                const s = a.content || a.stanza.content;
                let c = s.find((e) => "biz" === e.tag);
                c || ((c = u.websocket.smax("biz", {}, null)), s.push(c));
                let l = !1;
                return (
                  Array.isArray(c.content)
                    ? (l = !!c.content.find(
                        (e) => e.tag === (null == o ? void 0 : o.tag)
                      ))
                    : (c.content = []),
                  l || c.content.push(o),
                  a
            ...
            (0, l.wrapModuleFunction)(d.getABPropConfigValue, (e, ...t) => {
              const [r] = t;
              return (
                "web_unwrap_message_for_stanza_attributes" !== r && e(...t)
              );
            });
        });
      },
          ...
          (t.prepareRawMessage = async function (e, t, r = {}) {
            ...
            (r = Object.assign(
              ...
              (t = Object.assign(
                {
                  t: (0, u.unixTime)(),
                  from: a.UserPrefs.getMaybeMeUser(),
                  to: e.id,
                  self: "out",
                  isNewMsg: !0,
                  local: !0,
              ...
              r.delay &&
                ("chat" == t.type
                  ...
                  : (null == r ? void 0 : r.isPtt) &&
                    (await (0, l.markIsRecording)(e.id)),
            ...
            (null === (d = e.id) || void 0 === d ? void 0 : d.isBot()) &&
              (t = Object.assign(Object.assign({}, t), {
                messageSecret: await (0, u.genBotMsgSecretFromMsgSecret)(
                  crypto.getRandomValues(new Uint8Array(32))
                ),
                botPersonaId: a.BotProfileStore.get(
                  null === (f = e.id) || void 0 === f ? void 0 : f.toString()
                ).personaId,
              }));
            if (r.messageId) {
              if (
                ("string" == typeof r.messageId &&
                  (r.messageId = a.MsgKey.fromString(r.messageId)),
                !r.messageId.fromMe)
              )
                throw new i.WPPError(
            ...
            if (r.mentionedList) {
              const e = r.mentionedList.map((e) =>
                e instanceof a.Wid ? e : (0, n.assertWid)(e)
              );
              for (const t of e)
                if (!t.isUser())
                  throw new i.WPPError(
            ...
            if (r.quotedMsg) {
              if (
                ("string" == typeof r.quotedMsg &&
                  (r.quotedMsg = a.MsgKey.fromString(r.quotedMsg)),
                r.quotedMsg instanceof a.MsgKey &&
                  (r.quotedMsg = await (0, l.getMessageById)(r.quotedMsg)),
                !(r.quotedMsg instanceof a.MsgModel))
              )
                throw new i.WPPError(
                  "invalid_quoted_msg",
                  "Invalid quotedMsg",
      ...
      58267: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.requestPhoneNumber = async function (e, t = {}) {
            ...
            return await (0, a.sendRawMessage)(
              e,
      ...
      82028: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendChargeMessage = async function (e, t, r) {
            if (!t || !e)
              throw new n.WPPError(
                "parameter_not_fount",
              ...
              p = {
                ...
                payment_settings:
                  void 0 !== r.pix
                    ? [
                        {
                          pix_static_code: {
                            key: r.pix.key,
                            key_type: r.pix.keyType,
                            merchant_name: r.pix.name,
                          },
                    ...
                    : void 0,
                external_payment_configurations: r.payment_instruction
                  ? [
                      {
                        type: "payment_instruction",
                        payment_instruction: r.payment_instruction,
                      },
                    ]
                  : void 0,
              },
            ...
            return await (0, s.sendRawMessage)(e, g, r);
          });
        const n = r(62857),
          o = r(14647),
          i = r(52757),
      ...
      68011: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendCreatePollMessage = async function (e, t, r, i = {}) {
            ...
            return await (0, o.sendRawMessage)(e, a, i);
          });
        const n = r(74023),
          o = r(97829);
      },
      35824: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendEventMessage = async function (e, t) {
            var r;
            if (
              "string" ==
              ...
              throw new o.WPPError(
                "callType_is_invalid",
                `Param callType: ${t.callType} is not a valid type call. Use voice or video`
              );
            const u = new Date(1e3 * t.startTime);
            u.setHours(u.getHours() + 2);
            const c = Math.floor(u.getTime() / 1e3),
              l = {
                type: "event_creation",
                eventName: t.name || " ",
                eventLocation: null == t ? void 0 : t.location,
                eventDescription: (null == t ? void 0 : t.description) || " ",
                eventStartTime: t.startTime,
                eventEndTime: (null == t ? void 0 : t.endTime) || c,
                isEventCanceled: !1,
                callType: t.callType || 0,
                author:
                  null === (r = (0, n.getMyUserId)()) || void 0 === r
                    ? void 0
                    : r.toString(),
                kind: "eventCreation",
                ...
                viewMode: "VISIBLE",
                eventJoinLink:
                  "string" == typeof (null == t ? void 0 : t.callType)
                    ? await (0, i.createEventCallLink)(t.startTime, t.callType)
                    : void 0,
              };
            return await (0, s.sendRawMessage)(e, l, t);
          });
        const n = r(72927),
          o = r(62857),
          i = r(52757),
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendFileMessage = async function (e, t, r) {
            ...
            let a = (r = Object.assign(
              Object.assign(Object.assign({}, y.defaultSendMessageOptions), {
                type: "auto-detect",
                waveform: !0,
              }),
              r
              ...
              : (0, u.assertGetChat)(e);
            "status@broadcast" == (null == e ? void 0 : e.toString()) &&
              (a = new f.ChatModel({ id: (0, c.createWid)(m.STATUS_JID) }));
            const s = await (0, l.convertToFile)(t, r.mimetype, r.filename),
              d = s.name,
              g = await f.OpaqueData.createFromData(s, s.type),
              _ = {};
            let P;
            "audio" === r.type
              ? ((_.isPtt = r.isPtt),
                r.isPtt && (P = r.isViewOnce),
                (_.precomputedFields = await (0, h.prepareAudioWaveform)(r, s)))
              : "image" === r.type
              ? (P = r.isViewOnce)
              : "video" === r.type
              ? ((P = r.isViewOnce), (_.asGif = r.isGif))
              : "document" === r.type
              ? (_.asDocument = !0)
              : "sticker" === r.type && (_.asSticker = !0);
            const M = f.MediaPrep.prepRawMedia(g, _);
            let w = await (0, b.prepareRawMessage)(
              a,
              {
                caption: r.caption || d,
                filename: d,
                footer: r.footer,
                isCaptionByUser: null != r.caption,
              },
              r
            );
            (w = (0, b.prepareMessageButtons)(w, r)),
              r.markIsRead &&
                (v("marking chat is read before send file"),
                await (0, b.markIsRead)(a.id).catch(() => null));
            await M.waitForPrep(),
              (null == r ? void 0 : r.isPtv) &&
                ((M._mediaData.type = "ptv"),
                (M._mediaData.fullHeight = 1128),
                (M._mediaData.fullWidth = 1128));
            v(`sending message (${r.type}) with id ${w.id}`);
            const O = M.sendToChat(a, {
              caption: r.caption,
              footer: r.footer,
              isViewOnce: P,
              productMsgOptions: "status@broadcast" === e ? void 0 : w,
            ...
            j =
              "status@broadcast" ==
              (null === (n = w.to) || void 0 === n ? void 0 : n.toString())
                ? await new Promise((e) => {
                    f.StatusV3Store.on(
                ...
                : await new Promise((e) => {
                    a.msgs.on("add", function t(r) {
                      r.id === w.id && (a.msgs.off("add", t), e(r));
                    });
                  });
            function S(e, t) {
              v(`message file ${j.id} is ${t}`);
            }
            if (
              (v(`message file ${j.id} queued`),
              j.on("change:mediaData.mediaStage", S),
              O.finally(() => {
                j.off("change:mediaData.mediaStage", S);
              }),
              "status@broadcast" !== e)
            ) {
              if (r.waitForAck) {
              ...
              return {
                id: null === (o = j.id) || void 0 === o ? void 0 : o.toString(),
                ack: j.ack,
                sendMsgResult: O,
              };
            }
            {
              const e = await new Promise((e, t) => {
                const r = setTimeout(() => {
                  ...
                  n = setInterval(async () => {
                    const t = await (0, b.getMessageById)(j.id);
                    t.ack > 0 && (clearInterval(n), clearTimeout(r), e(t));
                  }, 1500);
              });
              return {
                id: null === (i = e.id) || void 0 === i ? void 0 : i.toString(),
                ack: e.ack,
                sendMsgResult: { messageSendResult: p.SendMsgResult.OK },
              };
            }
          });
        const s = a(r(17833)),
          ...
          b = r(97829),
          h = r(72185),
          v = (0, s.default)("WA-JS:message");
        d.onFullReady(() => {
          (0, g.wrapModuleFunction)(
            m.generateVideoThumbsAndDuration,
            async (e, ...t) => {
              const [r] = t;
              try {
                return await e(...t);
            ...
            (0, g.wrapModuleFunction)(m.processRawSticker, async (e, ...t) => {
              const [r] = t,
                n = await e(...t);
              if ("image/webp" === r.type()) {
                const e = r.forceToBlob(),
                  t = await (0, c.blobToArrayBuffer)(e);
                (0, m.isAnimatedWebp)(t) &&
            ...
            (0, g.wrapModuleFunction)(m.uploadMedia, async (e, ...t) => {
              const [r] = t;
      ...
      40954: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendGroupInviteMessage = async function (e, t) {
            ...
            const r = `https://chat.whatsapp.com/${t.inviteCode}`;
            let u = {};
            u = t.inviteCodeExpiration
              ? {
              ...
              : {
                  type: "chat",
                  subtype: "url",
                  thumbnail: t.jpegThumbnail,
                  thumbnailHeight: t.jpegThumbnail ? 100 : void 0,
                  thumbnailWidth: t.jpegThumbnail ? 100 : void 0,
                  title: t.groupName,
                  inviteGrpType: "DEFAULT",
                  canonicalUrl: `https://chat.whatsapp.com/${t.inviteCode}`,
                  description: t.caption ? `${t.caption}\n${r}` : r,
                  body: t.caption ? `${t.caption}\n${r}` : r,
                  matchedText: `https://chat.whatsapp.com/${t.inviteCode}`,
                  richPreviewType: 0,
                };
            return await (0, s.sendRawMessage)(e, u, t);
          });
        const n = r(56191),
          o = r(64456),
          i = r(62857),
      ...
      39453: function (e, t, r) {
        ...
        const a = i(r(1132)),
          ...
          d = r(43394);
        a.onFullReady(() => {
          (0, s.wrapModuleFunction)(u.mediaTypeFromProtobuf, (e, ...t) => {
            const [r] = t;
            return r.locationMessage ? null : e(...t);
          }),
            (0, s.wrapModuleFunction)(
      ...
      42992: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendPixKeyMessage = async function (e, t, r) {
            if (!(e && t.keyType && t.name && t.key))
              throw new n.WPPError(
                "parameter_not_fount",
                "Please, send all the required parameters"
              );
            r = Object.assign(
              Object.assign({}, o.defaultSendMessageOptions),
              r
            );
            const a = {
                order: {
                  items: [
                    {
                      name: "",
                      retailer_id: `custom-item-${n.generateOrderUniqueId}`,
                ...
                external_payment_configurations: [
                  {
                    payment_instruction: t.instructions,
                    type: "payment_instruction",
                  },
                ],
                additional_note: t.instructions,
                currency: "BRL",
                type: "physical-goods",
              },
              s = {
            ...
            return await (0, i.sendRawMessage)(e, s, r);
          });
        const n = r(62857),
          o = r(74023),
          i = r(97829);
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendRawMessage = async function (e, t, r = {}) {
            ...
            const o = (r = Object.assign(
              ...
              : (0, i.assertGetChat)(e);
            if (o.isGroup && o.isParentGroup) {
              const e = u.GroupMetadataStore.get(
                null === (n = o.id) || void 0 === n ? void 0 : n.toString()
              );
              if ("COMMUNITY" == (null == e ? void 0 : e.groupType)) {
                const t = (0, a.getAnnouncementGroup)(e.id);
            ...
            (t = await (0, f.prepareRawMessage)(o, t, r)),
              r.markIsRead &&
                (p("marking chat is read before send message"),
                await (0, f.markIsRead)(o.id).catch(() => null));
            p(`sending message (${t.type}) with id ${t.id}`);
            let g = null;
            if ((null == o ? void 0 : o.isNewsletter) && t.type) {
              ...
              const e = new u.MsgModel(t);
              await (0, l.addNewsletterMsgsRecords)([
                await (0, l.msgDataFromMsgModel)(e),
              ]);
              const r = await (0, l.sendNewsletterMessageJob)({
                type:
                  "chat" != t.type || t.editMsgType
                    ? "poll_creation" == t.type
                      ? "pollCreation"
                      : "media"
                    : "text",
                msgData: t,
                msg: new u.MsgModel(t),
                newsletterJid: o.id.toString(),
              });
              o.msgs.add(e),
                r.success && ((e.t = r.ack.t), (e.serverId = r.serverId)),
                e.updateAck(c.ACK.SENT, !0),
                await (0, l.updateNewsletterMsgRecord)(e),
                (g = [e, "OK"]);
            } else if ("protocol" === t.type && "message_edit" === t.subtype) {
              const e = await (0, f.getMessageById)(t.protocolMessageKey);
              await (0, l.addAndSendMessageEdit)(e, t),
                (g = [await (0, f.getMessageById)(t.protocolMessageKey), null]);
            } else g = await (0, l.addAndSendMsgToChat)(o, t);
            p(`message ${t.id} queued`);
            const m = await g[0];
            if (r.waitForAck) {
              p(`waiting ack for ${t.id}`);
              const e = await g[1];
              p(`ack received for ${t.id} (ACK: ${m.ack}, SendResult: ${e})`);
            }
            return Object.assign(
              Object.assign(
                Object.assign(
                  Object.assign(
                    { id: m.id.toString(), ack: m.ack },
                    m.latestEditMsgKey && {
                      latestEditMsgKey: m.latestEditMsgKey,
                    }
                  ),
                  m.from && { from: m.from.toString() }
                ),
                m.to && { to: m.to.toString() }
              ),
              { sendMsgResult: g[1] }
            );
          });
          ...
          (t.sendReactionToMessage = async function (e, t) {
            ...
            const r =
              e instanceof n.MsgModel
                ...
                : await (0, i.getMessageById)(e.toString());
            t || (t = "");
            return { sendMsgResult: await (0, o.sendReactionToMsg)(r, t) };
          });
        const n = r(14647),
          o = r(52757),
          i = r(17530);
          ...
          (t.sendScheduledCallMessage = async function (e, t) {
            ...
            return (
              (t = Object.assign(
                Object.assign(
                  { callType: "voice" },
                  n.defaultSendMessageOptions
                ),
                t
              )),
              await (0, o.sendEventMessage)(
                e,
          ...
          (t.sendVCardContactMessage = async function (e, t, r = {}) {
            ...
            for (const e of t) {
              ...
              i ||
                ...
                s.push(o.VCard.vcardFromContactModel(i));
            }
            const u = {};
            1 === s.length
              ? ((u.type = "vcard"),
                (u.body = s[0].vcard),
                (u.vcardFormattedName = s[0].displayName))
              : ((u.type = "multi_vcard"), (u.vcardList = s));
            return (0, a.sendRawMessage)(e, u, r);
          });
        const n = r(41687),
          o = r(14647),
          i = r(74023),
      ...
      43859: function (e, t, r) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.FilterChatListTypes = void 0),
          (t.setChatList = async function (e, t) {
            if (((f = e), !e))
              throw new a.WPPError(
                "send_type_filter",
            ...
            if (e == p.CUSTOM && !t)
              throw new a.WPPError("send_ids", "Please send a valid ids");
            "string" == typeof t && (t = [t]);
            return e == p.CUSTOM && t
              ? ((d = t),
                u.Cmd.trigger("set_active_filter", "unread"),
                u.Cmd.trigger("set_active_filter"),
                { type: e, list: d })
              : e == p.ALL
              ? (u.Cmd.trigger("set_active_filter"), { type: e })
              : e == p.LABELS
              ? (u.Cmd.trigger("set_active_filter", p.LABELS, t[0]),
                { type: e })
              : (u.Cmd.trigger("set_active_filter", "unread"),
                u.Cmd.trigger("set_active_filter", e),
                { type: e });
          }),
          (t.wrapShouldAppearFunction = function (e, t) {
            const r = (...r) => t(e, ...r);
            return (
              Object.defineProperties(
                r,
                Object.getOwnPropertyDescriptors(l.getShouldAppearInList)
              ),
              r
            );
          });
        ...
        !(function (e) {
          (e.ALL = "all"),
            ...
            (e.LABELS = "labels"),
            (e.ASSIGNED_TO_YOU = "assigned_to_you");
        })(p || (t.FilterChatListTypes = p = {})),
          s.onFullReady(function () {
            (0, c.wrapModuleFunction)(l.getShouldAppearInList, (e, ...t) => {
              var r;
              const [n] = t;
              return f === p.CUSTOM
                ? !!d.includes(
                    null === (r = n.id) || void 0 === r ? void 0 : r.toString()
                  )
                : e(...t);
            }),
              (0, c.wrapModuleFunction)(
                l.isFilterExcludedFromSearchTreatmentInInboxFlow,
                async (e, ...t) => {
                  const [r] = t;
                  return (
                    r === p.LABELS ||
                      (f == p.CUSTOM &&
                        ((f = p.ALL),
                        u.Cmd.trigger("set_active_filter", "default"),
                        u.Cmd.trigger("set_active_filter", r)),
                      (f = p.ALL),
                      u.Cmd.trigger("set_active_filter", r)),
                    e(...t)
                  );
      ...
      18194: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setInputText = async function (e, t) {
            const r =
              void 0 !== t
                ? await (0, n.assertFindChat)(t)
                : (0, o.getActiveChat)();
            if (r)
              return (null == r ? void 0 : r.active)
                ? (r.setComposeContents({
                    text: e,
                    timestamp: (0, s.unixTime)(),
                  }),
                  a.ComposeBoxActions.setTextContent(r, e),
                  r.getComposeContents())
                : (null == r ||
                    r.setComposeContents({
                      text: e,
                      timestamp: (0, s.unixTime)(),
          ...
          (t.setNotes = async function (e, t) {
            ...
            if (r.isGroup)
              throw new i.WPPError(
                ...
                `You can not set notes for groups. ChatId: ${e}`
              );
            const s = await (0, a.retrieveOnlyNoteForChatJid)(r.id.toJid());
            return (
              await (0, a.addOrEditNoteAction)(
                {
                  actionType: s ? "edit" : "add",
                  chatJid: r.id.toJid(),
                  content: t,
              ...
              await (0, a.retrieveOnlyNoteForChatJid)(r.id.toJid())
            );
          });
        const n = r(41687),
          o = r(5882),
      ...
      37126: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.starMessage = async function (e, t = !0) {
            ...
            const a = await (0, i.getMessageById)(e),
              s = a.reduce((e, t) => {
                const r = t.id.remote.toString();
                return (e[r] = e[r] || []), e[r].push(t), e;
              }, {}),
              u = a.map((e) => ({ id: e.id.toString(), star: e.star || !1 }));
            for (const e in s) {
              const r = (0, n.assertGetChat)(e),
                i = s[e];
      ...
      35291: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.unmute = async function (e) {
            const t = (0, n.assertWid)(e);
            return (0, n.assertGetChat)(t).mute.unmute({ sendDevice: !0 });
          });
        const n = r(41687);
      },
      ...
      72465: function (e, t, r) {
        ...
        a.onFullReady(function () {
          (0, u.wrapModuleFunction)(c.mediaTypeFromProtobuf, (e, ...t) => {
            ...
            (0, u.wrapModuleFunction)(c.isUnreadTypeMsg, (e, ...t) => {
              const [r] = t;
              switch (r.type) {
            ...
            (0, u.wrapModuleFunction)(
              c.findOrCreateLatestChat,
              async (e, ...t) => {
                const [r, n] = t;
                if (r.isLid() && "username_contactless_search" != n)
                  try {
                    return await e(...t);
                  } catch (t) {
                    return await e(r, "username_contactless_search");
                  }
                return await e(...t);
              }
            );
          ...
          a.onFullReady(function () {
            const e = {
              shouldAppearInList: s.functions.getShouldAppearInList,
              isUser: s.functions.getIsUser,
              isPSA: s.functions.getIsPSA,
              isGroup: s.functions.getIsGroup,
              previewMessage: s.functions.getPreviewMessage,
              showChangeNumberNotification:
                s.functions.getShowChangeNumberNotification,
              hasUnread: s.functions.getHasUnread,
            };
            for (const t in e) {
              const r = e[t];
              void 0 === s.ChatModel.prototype[t] &&
                Object.defineProperty(s.ChatModel.prototype, t, {
                  get: function () {
                    return r(this);
                  },
                  configurable: !0,
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.create = async function (e, t, r) {
            ...
            const i = r.map(n.assertWid),
              a = await (0, o.sendCreateCommunity)({
                name: e,
                desc: t,
                closed: !1,
              }),
              s = await (0, o.sendLinkSubgroups)({
                parentGroupId: a.wid,
                subgroupIds: i,
              });
      ...
      58092: function (e, t, r) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.demoteParticipants = async function (e, t) {
            ...
            a.ensureGroupAndParticipants)(e, t);
            try {
              return (
                await s.demoteCommunityParticipants(r, n),
      ...
      9820: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getAnnouncementGroup = function (e) {
            const t = (0, o.getSubgroups)(e);
            for (const e of t) {
              const t = n.GroupMetadataStore.get(e.toString());
              if (
                "LINKED_ANNOUNCEMENT_GROUP" ==
                (null == t ? void 0 : t.groupType)
              )
                return t.id;
            }
            return;
      ...
      84460: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getSubgroups = function (e) {
            var t, r;
            const i = o.GroupMetadataStore.get(e.toString());
            if (!i)
              throw new n.WPPError(
                "group_not_exist",
                `GroupId ${null == e ? void 0 : e.toString()} not exists`
              );
            if (
              (null === (t = i.joinedSubgroups) || void 0 === t
                ? void 0
                : t.length) > 0
            )
              return i.joinedSubgroups;
            return o.GroupMetadataStore.get(
              null === (r = i.parentGroup) || void 0 === r
                ? void 0
                : r.toString()
            ).joinedSubgroups;
          });
      ...
      5728: (e, t, r) => {
        ...
        var s = r(9820);
        Object.defineProperty(t, "getAnnouncementGroup", {
          enumerable: !0,
          get: function () {
        ...
        var c = r(84460);
        Object.defineProperty(t, "getSubgroups", {
          enumerable: !0,
          get: function () {
      ...
      84498: function (e, t, r) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.promoteParticipants = async function (e, t) {
            const { groupChat: r, participants: n } = await (0,
            a.ensureGroupAndParticipants)(e, t);
            return s.promoteCommunityParticipants(r, n);
          });
        const a = r(64456),
          s = i(r(52757));
      },
      ...
      91491: (e, t, r) => {
        ...
        const n = r(13691),
          o = r(10896),
          i = window.WPPConfig || {},
          a = Object.assign(Object.assign({}, o.defaultConfig), i),
          s = (e = []) => ({
            get: (t, r) =>
              "isProxy" == r ||
      ...
      21899: function (e, t, r) {
        ...
        s.onInjected(function () {
          const e = async () => {
            ...
            a.internalEv.emit("conn.auth_code_change", e);
          };
      ...
      87589: function (e, t, r) {
        ...
        s.onInjected(function () {
          ...
          const t = async () => {
            e || (a.internalEv.emit("conn.authenticated"), (e = !1));
          };
      ...
      75676: function (e, t, r) {
        ...
        const a = r(13691),
          ...
          u = r(14647);
        s.onInjected(function () {
          u.Cmd.on("logout", () => a.internalEv.emit("conn.logout"));
        });
      },
      83400: function (e, t, r) {
        ...
        s.onInjected(function () {
          (0,
          u.wrapModuleFunction)(c.getErrorCodeFromLogoutReason, (e, ...t) => {
            const [r] = t;
            return a.internalEv.emit("conn.logout_reason", r), e(...t);
          });
        });
      },
      77679: function (e, t, r) {
        ...
        s.onInjected(function () {
          const e = setInterval(() => {
            (0, u.isMainInit)() &&
              (clearInterval(e), a.internalEv.emit("conn.main_init"));
          }, 100);
        });
      },
      26: function (e, t, r) {
        ...
        s.onInjected(function () {
          const e = async () => {
            a.internalEv.emit("conn.main_loaded");
          };
        ...
        s.onInjected(function () {
          const e = async () => {
            c ||
              ((c = !0),
              setTimeout(() => (c = !1), 1e3),
              a.internalEv.emit("conn.main_ready"));
          };
          "MAIN" === u.Stream.mode
            ? e()
            : (u.Cmd.on("main_stream_mode_ready", e),
      ...
      19516: function (e, t, r) {
        ...
        s.onInjected(function () {
          const e = async () => {
            a.internalEv.emit("conn.needs_update");
          };
      ...
      80739: function (e, t, r) {
        ...
        s.onInjected(function () {
          u.NetworkStatus.on("change:online", (e, t) => {
            a.internalEv.emit("conn.online", t);
          });
        });
      },
      96498: function (e, t, r) {
        ...
        s.onInjected(function () {
          const e = async () => {
            (0, c.isIdle)() && a.internalEv.emit("conn.qrcode_idle");
          };
          ...
          const t = async () => {
            (0, l.isAuthenticated)()
              ...
              : e ||
                ...
                ((e = !0), a.internalEv.emit("conn.require_auth"));
          };
          ...
          (t.getAuthCode = async function () {
            ...
            if ((0, i.isMultiDevice)()) {
              const t = await o.waSignalStore.getRegistrationInfo(),
                ...
                a = n.Base64.encodeB64(t.identityKeyPair.pubKey),
                s = await Promise.resolve(o.adv.getADVSecretKey()),
                u = [e, i, a, s].join(",");
              return {
                type: "multidevice",
                ref: e,
      ...
      11057: function (e, t, r) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getHistorySyncProgress = function () {
            const e = a.getHistorySyncProgress();
            return {
              progress: e.progress,
              paused: e.paused || !1,
          ...
          (t.setLimit = function (e, t) {
            switch (e) {
              ...
              case "unlimitedPin":
                ...
                return (d = t || void 0), t;
              default:
                throw new a.WPPError("setLimit_error", "Key type invalid!");
            }
          });
        const a = r(62857),
          s = i(r(1132)),
      ...
      15610: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setMultiDevice = function (e = !0) {
            e ? n.Cmd.upgradeToMDProd() : n.Cmd.downgradeWebclient();
            return !0;
          });
        const n = r(14647);
      },
      ...
      51369: function (e, t, r) {
        ...
        const a = i(r(1132)),
          s = r(14647);
        a.onInjected(() => {
          s.IsOfficialClient.isOfficialClient = !0;
        });
      },
      14282: (e, t) => {
        "use strict";
      ...
      81676: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getCommonGroups = async function (e) {
            ...
            if (!t) return [];
            return (await n.functions.findCommonGroups(t))
              .getModelsArray()
              .map((e) => e.id);
          });
        const n = r(14647);
      ...
      23199: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getStatus = async function (e) {
            const t = (0, n.assertWid)(e);
            if (!(await (0, i.queryExists)(t))) return null;
            return (await o.StatusStore.find(t)).status || null;
          });
        const n = r(41687),
          o = r(14647),
          i = r(53141);
      ...
      20941: (e, t, r) => {
        ...
        var l = r(316);
        Object.defineProperty(t, "subscribePresence", {
          enumerable: !0,
          get: function () {
            return l.subscribePresence;
          },
        });
        var d = r(17485);
        Object.defineProperty(t, "unsubscribePresence", {
          enumerable: !0,
          get: function () {
            return d.unsubscribePresence;
          },
        });
      },
      62041: (e, t, r) => {
      ...
      53141: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.queryExists = async function (e) {
            var t, r, a, s, u;
            const c = (0, n.assertWid)(e),
              l = c.toString();
            if (i.has(l)) return i.get(l);
            const d = new o.USyncUser(),
              f = new o.USyncQuery();
            c.toString().includes("@lid")
              ? d.withId(c)
              : (f.withContactProtocol(), d.withPhone("+" + l));
            f.withUser(d),
              f.withBusinessProtocol(),
              f.withDisappearingModeProtocol(),
              f.withStatusProtocol(),
              f.withLidProtocol();
            const p = await f.execute();
            let g = null;
            ((null === (t = null == p ? void 0 : p.error) || void 0 === t
              ? void 0
              : t.all) ||
              (null === (r = null == p ? void 0 : p.error) || void 0 === r
                ? void 0
                : r.contact)) &&
              (g = null);
            Array.isArray(p.list)
              ? ((g = p.list[0]),
                (g =
                  "out" ===
                  (null === (a = null == g ? void 0 : g.contact) || void 0 === a
                    ? void 0
                    : a.type)
                    ? null
                    : {
                        wid: g.id,
                        biz: void 0 !== g.business,
                        bizInfo: g.business,
                        disappearingMode:
                          void 0 !== g.disappearing_mode
                            ? {
                                duration:
                                  null === (s = g.disappearing_mode) ||
                                  void 0 === s
                                    ? void 0
                                    : s.duration,
                                settingTimestamp:
                                  null === (u = g.disappearing_mode) ||
                                  void 0 === u
                                    ? void 0
                                    : u.t,
                              }
      ...
      316: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.subscribePresence = async function (e) {
            Array.isArray(e) || (e = [e]);
            const t = [];
            for (const r of e)
              try {
                const e = n.WidFactory.createWid(r);
                if (
                  (await (0, o.subscribePresence)(e), n.PresenceStore.get(e))
                ) {
                  t.push(e);
                  continue;
                }
                await n.PresenceStore.find(e), t.push(e);
              } catch (e) {}
            return t;
          });
        const n = r(14647),
      ...
      17485: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.unsubscribePresence = async function (e) {
            Array.isArray(e) || (e = [e]);
            const t = [];
            for (const r of e) {
              const e = n.WidFactory.createWid(r),
                o = n.PresenceStore.get(e);
              o ? (o.delete(), t.push(e)) : t.push(e);
            }
            return t;
          });
        const n = r(14647);
      ...
      54409: function (e, t, r) {
        ...
        a.onInjected(function () {
          const e = {
            isMyContact: s.functions.getIsMyContact,
            mentionName: s.functions.getMentionName,
            notifyName: s.functions.getNotifyName,
            pnForLid: s.functions.getPnForLid,
            displayNameOrPnForLid: s.functions.getDisplayNameOrPnForLid,
            formattedPhone: s.functions.getFormattedPhone,
            userid: s.functions.getUserid,
            userhash: s.functions.getUserhash,
            searchName: s.functions.getSearchName,
            searchVerifiedName: s.functions.getSearchVerifiedName,
            header: s.functions.getHeader,
            isMe: s.functions.getIsMe,
            isUser: s.functions.getIsUser,
            isGroup: s.functions.getIsGroup,
            isBroadcast: s.functions.getIsBroadcast,
            isPSA: s.functions.getIsPSA,
            isIAS: s.functions.getIsIAS,
            isSupportAccount: s.functions.getIsSupportAccount,
            formattedShortNameWithNonBreakingSpaces:
              s.functions.getFormattedShortNameWithNonBreakingSpaces,
            formattedShortName: s.functions.getFormattedShortName,
            formattedName: s.functions.getFormattedName,
            formattedUser: s.functions.getFormattedUser,
            isWAContact: s.functions.getIsWAContact,
            canRequestPhoneNumber: s.functions.getCanRequestPhoneNumber,
            showBusinessCheckmarkAsPrimary:
              s.functions.getShowBusinessCheckmarkAsPrimary,
            showBusinessCheckmarkAsSecondary:
              s.functions.getShowBusinessCheckmarkAsSecondary,
            showBusinessCheckmarkInChatlist:
              s.functions.getShowBusinessCheckmarkInChatlist,
            isDisplayNameApproved: s.functions.getIsDisplayNameApproved,
            shouldForceBusinessUpdate: s.functions.getShouldForceBusinessUpdate,
          };
          for (const t in e) {
            const r = e[t];
            void 0 === s.ContactModel.prototype[t] &&
              Object.defineProperty(s.ContactModel.prototype, t, {
                get: function () {
                  return r(this);
                },
                configurable: !0,
      ...
      80687: function (e, t, r) {
        ...
        const a = r(91491),
          s = i(r(1132));
        s.onInjected(() => {
          if (!a.config.deviceName) return;
          const e = s.search((e) => e.default.info && e.default.hardRefresh);
          if (e) {
            const t = e.default.info();
            (t.os = a.config.deviceName),
              (t.version = void 0),
              (t.name = void 0),
              (t.ua = void 0),
              (e.default.info = () => t);
      ...
      83734: (e, t) => {
        ...
        var r, n;
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.PrivacyDisallowedListType = t.TextFontStyle = void 0),
          (function (e) {
            (e[(e.SANS_SERIF = 0)] = "SANS_SERIF"),
              (e[(e.SERIF = 1)] = "SERIF"),
              (e[(e.NORICAN_REGULAR = 2)] = "NORICAN_REGULAR"),
              (e[(e.BRYNDAN_WRITE = 3)] = "BRYNDAN_WRITE"),
              (e[(e.BEBASNEUE_REGULAR = 4)] = "BEBASNEUE_REGULAR"),
              (e[(e.OSWALD_HEAVY = 5)] = "OSWALD_HEAVY");
          })(r || (t.TextFontStyle = r = {})),
          (function (e) {
            (e.About = "status"),
              (e.GroupAdd = "groupadd"),
              (e.LastSeen = "last"),
              (e.ProfilePicture = "profile");
      ...
      13691: function (e, t, r) {
        ...
        (t.internalEv = new s.EventEmitter({ maxListeners: 1 / 0 })),
          (t.ev = new s.EventEmitter({ maxListeners: 1 / 0 })),
                ...
                queueMicrotask(() => {
                  ...
                  "add" !== i || (!o.isInvite && "invite" !== o.reason)
                    ? "remove" === i &&
                      ...
                      (i = "leave")
                    : (i = "join"),
                    a.internalEv.emit("group.participant_changed", {
                      author:
      ...
      7103: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.addParticipants = async function (e, t) {
            ...
            a.ensureGroupAndParticipants)(e, t, !0);
            let d = [];
            ...
            for (const e of f.participants || []) {
              ...
              p[t] = {
                wid: t,
                code: Number(r),
                message: s[Number(r)] || "Can't Join., unknown error",
                invite_code: n,
                invite_code_exp: Number(a) || null,
              };
            }
            return p;
          });
      ...
      20292: function (e, t, r) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.create = async function (e, t, r) {
            ...
            const p = r ? (0, a.assertWid)(r) : void 0,
      ...
      42490: function (e, t, r) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.demoteParticipants = async function (e, t) {
            ...
            return s.demoteParticipants(r, n);
          });
        const a = r(62857),
          s = i(r(52757)),
          u = r(97944);
      ...
      23527: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.ensureGroup = async function (e, t = !1) {
            ...
            const s = await i.GroupMetadataStore.find(r.id);
            if (
              t &&
              !(await (0, a.iAmAdmin)(e)) &&
              "all_member_add" !== s.memberAddMode
            )
              throw new o.WPPError(
      ...
      97944: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.ensureGroupAndParticipants = async function (e, t, r = !1) {
            const s = await (0, a.ensureGroup)(e, !0);
            Array.isArray(t) || (t = [t]);
            const u = t.map(n.assertWid).map((e) => {
              var t;
              let n =
                null === (t = s.groupMetadata) || void 0 === t
                  ? void 0
                  : t.participants.get(e);
              if ((!n && r && (n = new i.ParticipantModel({ id: e })), !n))
                throw new o.WPPError(
                  "group_participant_not_found",
                  `Group ${s.id._serialized}: Participant '${n}' not found`
                );
              return n;
            });
            return { groupChat: s, participants: u };
          });
        const n = r(41687),
          o = r(62857),
          i = r(14647),
      ...
      45195: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getGroupInfoFromInviteCode = async function (e) {
            ...
            const a = await (0, o.sendQueryGroupInvite)(e).catch(() => null);
            if (!a)
              throw new n.WPPError(
                "invalid_invite_code",
                "Invalid Invite Code",
            ...
            return Object.assign(Object.assign({}, a), {
              descOwner:
                null === (t = a.descOwner) || void 0 === t
                  ? void 0
                  : t.toString(),
              id: a.id.toString(),
              owner:
                null === (r = a.owner) || void 0 === r ? void 0 : r.toString(),
              participants: a.participants.map((e) =>
                Object.assign(Object.assign({}, e), { id: e.id.toString() })
              ),
              subjectOwner:
                null === (i = a.subjectOwner) || void 0 === i
                  ? void 0
                  : i.toString(),
            });
          });
      ...
      21268: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getPastParticipants = async function (e) {
            return (
              await (0, n.ensureGroup)(e)
      ...
      2818: (e, t, r) => {
        ...
        var v = r(21268);
        Object.defineProperty(t, "getPastParticipants", {
          enumerable: !0,
          get: function () {
            return v.getPastParticipants;
          },
        });
        var _ = r(68780);
        ...
        Object.defineProperty(t, "GroupProperty", {
          enumerable: !0,
          get: function () {
            return k.GroupProperty;
          },
        }),
          Object.defineProperty(t, "setProperty", {
            enumerable: !0,
            get: function () {
              return k.setProperty;
            },
          });
        var B = r(36520);
      ...
      84784: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.join = async function (e) {
            ...
            return { id: (await (0, n.sendJoinGroupViaInvite)(e)).toString() };
          });
        const n = r(52757);
      },
      3329: (e, t, r) => {
      ...
      10964: function (e, t, r) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.promoteParticipants = async function (e, t) {
            ...
            return s.promoteParticipants(r, n);
          });
        const a = r(62857),
          s = i(r(52757)),
          u = r(97944);
      ...
      84054: function (e, t, r) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.removeParticipants = async function (e, t) {
            Array.isArray(t) || (t = [t]);
            const r = await (0, c.ensureGroup)(e, !0),
              n = [];
            if (
              (t.map(a.assertWid).map((e) => {
                var t;
                (null === (t = r.groupMetadata) || void 0 === t
                  ? void 0
                  : t.participants.get(e)) && n.push(e);
              }),
              0 === n.length)
            )
              throw new s.WPPError(
                "not_valid_group_participants",
                `No valid participants found for the group ${e}`
              );
            const { participants: o } = await (0, l.ensureGroupAndParticipants)(
              e,
              n
            );
            if (
            ...
            return u.removeParticipants(r, o);
          });
        const a = r(41687),
          s = r(62857),
          u = i(r(52757)),
          ...
          (t.setDescription = async function (e, t) {
            ...
            if (
              ...
              throw new n.WPPError(
                ...
                `You are not allowed to set group description in ${s.id._serialized}`,
            ...
            return (
              await (0, o.sendSetGroupDescription)(
                ...
                t,
                u,
                null === (a = s.groupMetadata) || void 0 === a
                  ? void 0
                  : a.descId
              ),
              (s.groupMetadata.descId = u),
              (s.groupMetadata.desc = t),
              !0
            );
          });
        const n = r(62857),
      ...
      99403: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setIcon = async function (e, t) {
            ...
            const a = await (0, n.convertToFile)(t),
              s = await (0, n.resizeImage)(a, {
                width: 96,
                height: 96,
                mimeType: "image/jpeg",
                resize: "cover",
              }),
              u = await (0, n.resizeImage)(a, {
                width: 640,
                height: 640,
                mimeType: "image/jpeg",
                resize: "cover",
      ...
      76131: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.GroupProperty = void 0),
          (t.setProperty = async function (e, t, r) {
            var s, u;
            const c = await (0, i.ensureGroup)(e);
            if (
              t !== a.ANNOUNCEMENT &&
              !(null === (s = c.groupMetadata) || void 0 === s
                ? void 0
                : s.canSetGroupProperty())
            )
              throw new n.WPPError(
          ...
          (t.setSubject = async function (e, t) {
            ...
            if (
              ...
              throw new n.WPPError(
                ...
                `You are not allowed to set group subject in ${a.id._serialized}`,
                { groupId: a.id.toString() }
              );
            return (
              await (0, o.sendSetGroupSubject)(a.id, t),
              (a.name = t),
              (a.formattedTitle = t),
              !0
            );
      ...
      26738: function (e, t, r) {
        ...
        class a {
          ...
          getHeader() {
            const { cid: e, firstVisit: t } = a.clientState;
            return {
              v: 2,
              tid: this.trackingId,
              _p: a.pageLoadHash,
        ...
        (t.Tracker = a),
          (a.collectURL = "https://www.google-analytics.com/g/collect"),
          (a.pageLoadHash = i()),
          n([(0, o.debounce)(1e3)], a.prototype, "processEvents", null),
          n([(0, o.debounce)(3e5)], a.prototype, "processUserEngagement", null);
      },
      22418: function (e, t, r) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.trackException = function (e, t = !1) {
            if (s.config.disableGoogleAnalytics) return;
        ...
        const s = r(91491),
          ...
          c = r(13691),
          l = r(26738);
        a(r(26738), t), (t.waVersion = "3.15.1");
        const d = ["W: ", "-", ", WA-JS: ", t.waVersion],
          f = new l.Tracker("G-MTQ4KY110F"),
          p = s.config.googleAnalyticsId
            ? new l.Tracker(s.config.googleAnalyticsId)
            : null;
        c.internalEv.on("webpack.injected", () => {
          ...
          if (
            ...
            f.setUserProperty("powered_by", s.config.poweredBy || "-"),
            ...
            if (
              ...
              p.setUserProperty("powered_by", s.config.poweredBy || "-"),
              c.internalEv.on("conn.main_init", () => {
                var e;
                (d[1] =
                  (null === (e = window.Debug) || void 0 === e
              ...
              "object" == typeof s.config.googleAnalyticsUserProperty)
            )
          ...
          s.config.disableGoogleAnalytics ||
      ...
      4475: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.addNewLabel = async function (e, t = {}) {
            ...
            let r = t.labelColor || void 0;
            r || (r = await (0, a.getNewLabelColor)());
            "string" == typeof r &&
              r.length > 2 &&
              (r = (0, i.getAllLabelColors)().findIndex((e) => e === r));
            if (
              ((r = parseInt(r.toString())),
              !(await (0, a.colorIsInLabelPalette)(r)))
            )
              throw new o.WPPError(
                "color_not_in_pallet",
                "Color not in pallet"
            ...
            return (
              await (0, i.labelAddAction)(e, r),
              await (0, a.getLabelById)(s.toString())
            );
          });
        const n = r(41687),
          o = r(62857),
      ...
      3105: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.addOrRemoveLabels = async function (e, t) {
            (0, n.assertIsBusiness)(), Array.isArray(e) || (e = [e]);
            Array.isArray(t) || (t = [t]);
      ...
      9793: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.colorIsInLabelPalette = async function (e) {
            ...
            return (
              t &&
              (t.includes(e.toString()) || null != t[parseInt(e.toString())])
            );
          });
        const n = r(41687),
          o = r(62540);
            ...
            for (const t of e) {
              ...
              e &&
                ...
                r.push({
                  id: t,
                  deleteLabelResult:
                    null != e && null == o.LabelStore.get(t.toString()),
                });
            }
            if (t) return r[0];
            return r;
      ...
      40866: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.editLabel = async function (e, t = {}) {
            (0, n.assertIsBusiness)();
            const r = i.LabelStore.get(e.toString());
            if (!r)
              throw new o.WPPError(
                "label_not_exist",
                `Label with id ${e} not exist`
              );
            let u = t.labelColor || void 0;
            if (
              u &&
              ("string" == typeof u &&
                u.length > 2 &&
                (u = (0, a.getAllLabelColors)().findIndex((e) => e === u)),
              (u = parseInt(u.toString())),
              !(await (0, s.colorIsInLabelPalette)(u)))
            )
              throw new o.WPPError(
                "color_not_in_pallet",
                "Color not in pallet"
            ...
            return (
              await (0, a.labelEditAction)(
                e,
                t.name || r.name,
                0,
                u || r.colorIndex
              ),
              await (0, s.getLabelById)(e.toString())
            );
          });
        const n = r(41687),
          o = r(62857),
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getAllLabels = async function () {
            return o.LabelStore.getModelsArray().map((e) => ({
              ...
              count: e.count || 0,
              hexColor: (0, i.colorIndexToHex)(e.colorIndex),
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getLabelById = async function (e) {
            ...
            return {
              id: t.id,
              name: t.name,
              color: t.hexColor ? (0, n.assertColor)(t.hexColor) : null,
              count: t.count || 0,
              hexColor: (0, a.colorIndexToHex)(t.colorIndex),
      ...
      34753: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getNewLabelColor = async function () {
            (0, n.assertIsBusiness)();
            const e = await i.LabelStore.getNextAvailableColor();
            if (!e)
              throw new o.WPPError(
                "cannot_get_color",
      ...
      62540: (e, t, r) => {
        ...
        var u = r(40866);
        Object.defineProperty(t, "editLabel", {
          enumerable: !0,
          get: function () {
            return u.editLabel;
          },
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.create = async function (e, t) {
            ...
            if (null == t ? void 0 : t.picture) {
              ...
              (s = await (0, n.blobToBase64)(e)),
                ({ data: s } = await (0, n.downloadImage)(s, "image/jpeg"));
            }
              ...
              timestamp:
                null ===
                  (a =
                    null == u
                      ? void 0
                      : u.newsletterCreationTimeMetadataMixin) || void 0 === a
                  ? void 0
                  : a.creationTimeValue,
            };
          });
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.edit = async function (e, t) {
            ...
            return {
              ...
              state:
                null ===
                  (a = null == d ? void 0 : d.newsletterStateMetadataMixin) ||
                void 0 === a
                  ? void 0
                  : a.stateType,
              subscribersCount:
                  ...
                  (u =
                    null ===
                      (s =
                        null == d
                          ? void 0
                          : d.newsletterDescriptionMetadataMixin) ||
                    void 0 === s
                      ? void 0
                      : s.descriptionQueryDescriptionResponseMixin) ||
                void 0 === u
                  ? void 0
                  : u.elementValue,
              timestamp:
                null ===
                  (c =
                    null == d
                      ? void 0
                      : d.newsletterCreationTimeMetadataMixin) || void 0 === c
                  ? void 0
                  : c.creationTimeValue,
            };
          });
      ...
      37069: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getSubscribers = async function (e) {
            if (!e || !e.includes("newsletter"))
              throw new n.WPPError(
                "send_correctly_newsletter_id",
                "Please, send the correct newsletter ID."
            ...
            try {
              return (await (0, o.getNewsletterSubscribers)(e, 9, "LIMITED"))
                .subscribers;
            } catch (e) {
              return !1;
            }
      ...
      48812: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.mute = t.getSubscribers = t.edit = t.destroy = t.create = void 0);
        var n = r(8686);
        Object.defineProperty(t, "create", {
          enumerable: !0,
          get: function () {
        ...
        var a = r(37069);
        Object.defineProperty(t, "getSubscribers", {
          enumerable: !0,
          get: function () {
      ...
      55497: function (e, t, r) {
        ...
        s.onInjected(() => {
          u.MsgStore.on("add", (e) => {
            ...
            queueMicrotask(() => {
              a.internalEv.emit("order.payment_status", {
      ...
      95629: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.get = async function () {
            return Object.assign(
              Object.assign({}, (0, n.getUserPrivacySettings)()),
              { status: await (0, n.getStatusPrivacySetting)() }
            );
          });
        const n = r(52757);
      },
      73865: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getDisallowedList = async function (e) {
            if (
              "string" != typeof e ||
              !Object.values(n.PrivacyDisallowedListType).includes(e)
            )
              throw new o.WPPError(
                "incorrect_type",
            ...
            const t = await (0, i.getPrivacyDisallowedListTable)().get(e);
            return t ? t.disallowedList : null;
          });
        const n = r(83734),
          o = r(62857),
          i = r(52757);
      ...
      85837: (e, t, r) => {
        ...
        var i = r(99804);
        Object.defineProperty(t, "setAbout", {
          enumerable: !0,
          get: function () {
            return i.setAbout;
          },
        ...
        var a = r(26947);
        Object.defineProperty(t, "setAddGroup", {
          enumerable: !0,
          get: function () {
        ...
        var s = r(56414);
        Object.defineProperty(t, "setLastSeen", {
          enumerable: !0,
          get: function () {
        ...
        var u = r(41898);
        Object.defineProperty(t, "setOnline", {
          enumerable: !0,
          get: function () {
            return u.setOnline;
          },
        ...
        var c = r(84474);
        Object.defineProperty(t, "setProfilePic", {
          enumerable: !0,
          get: function () {
        ...
        var l = r(81096);
        Object.defineProperty(t, "setReadReceipts", {
          enumerable: !0,
          get: function () {
        ...
        var d = r(85019);
        Object.defineProperty(t, "setStatus", {
          enumerable: !0,
          get: function () {
            return d.setStatus;
          },
      ...
      77602: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.prepareDisallowedList = async function (e, t, r) {
            if ("contact_blacklist" !== t)
            ...
            const s = await (0, a.getPrivacyDisallowedListTable)().get(e);
            if (!r || 0 === (null == r ? void 0 : r.length)) {
              ...
              return {
                ids: s.disallowedList.map(
                  (e) =>
                    new i.Wid(e, { intentionallyUsePrivateConstructor: !0 })
                ),
                dhash: s.dhash,
                idsFormatted: [],
                allUsers: s.disallowedList.map(
                  (e) =>
                    new i.Wid(e, { intentionallyUsePrivateConstructor: !0 })
                ),
              };
            ...
            if (null == s)
              return {
                ids: (r =
                  null == r
                    ? void 0
                    : r.filter((e) => "remove" !== e.action)).map(
                  (e) =>
                    new i.Wid(e.id, { intentionallyUsePrivateConstructor: !0 })
                ),
                dhash: null,
                idsFormatted: r.map((e) => ({
                  wid: new i.Wid(e.id, {
            ...
            const u = s.disallowedList.filter(
                (e) => !r.some((t) => "remove" === t.action && t.id === e)
              ),
              c = r.filter((e) => "remove" !== e.action),
              l = [].concat(
                c.map(
                  (e) =>
                    new i.Wid(e.id, { intentionallyUsePrivateConstructor: !0 })
      ...
      99804: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setAboutTypes = void 0),
          (t.setAbout = async function (e, t) {
            if ("string" != typeof e || !Object.values(s).includes(e))
              throw new o.WPPError(
                "incorrect_type",
                `Incorrect type ${e || "<empty>"} for set about privacy`,
                { value: e }
              );
            const r = await (0, a.prepareDisallowedList)(
              n.PrivacyDisallowedListType.About,
              e,
              t
            );
            return (
              await (0, i.setPrivacyForOneCategory)(
                {
                  name: n.PrivacyDisallowedListType.About,
                  value: e,
                  dhash: "contact_blacklist" === e ? r.dhash : null,
                  users: "contact_blacklist" === e ? r.idsFormatted : void 0,
                },
                "contact_blacklist" === e ? r.allUsers : void 0
              ),
              (0, i.getUserPrivacySettings)().about
            );
          });
        const n = r(83734),
          o = r(62857),
        ...
        !(function (e) {
          (e.all = "all"),
            (e.contacts = "contacts"),
            (e.none = "none"),
            (e.contact_blacklist = "contact_blacklist");
        })(s || (t.setAboutTypes = s = {}));
      },
      26947: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setAddGroupTypes = void 0),
          (t.setAddGroup = async function (e, t) {
            if ("string" != typeof e || !Object.values(s).includes(e))
              throw new o.WPPError(
                "incorrect_type",
                `Incorrect type ${e || "<empty>"} for set add group privacy`,
                { value: e }
              );
            const r = await (0, a.prepareDisallowedList)(
              n.PrivacyDisallowedListType.GroupAdd,
              e,
              t
            );
            return (
              await (0, i.setPrivacyForOneCategory)(
                {
                  name: n.PrivacyDisallowedListType.GroupAdd,
                  value: e,
                  dhash: "contact_blacklist" === e ? r.dhash : null,
                  users: "contact_blacklist" === e ? r.idsFormatted : void 0,
                },
              ...
              (0, i.getUserPrivacySettings)().groupAdd
            );
          });
        const n = r(83734),
          o = r(62857),
      ...
      56414: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setLastSeenTypes = void 0),
          (t.setLastSeen = async function (e, t) {
            if ("string" != typeof e || !Object.values(s).includes(e))
              throw new o.WPPError(
                "incorrect_type",
                `Incorrect type ${e || "<empty>"} for set last seen privacy`,
                { value: e }
              );
            const r = await (0, a.prepareDisallowedList)(
              n.PrivacyDisallowedListType.LastSeen,
              e,
              t
            );
            return (
              ...
              (0, i.getUserPrivacySettings)().lastSeen
            );
          });
        const n = r(83734),
          o = r(62857),
      ...
      41898: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setOnlineTypes = void 0),
          (t.setOnline = async function (e) {
            if ("string" != typeof e || !Object.values(i).includes(e))
              throw new n.WPPError(
                "incorrect_type",
            ...
            return (
              await (0, o.setPrivacyForOneCategory)({
                name: "online",
                value: e,
              }),
              (0, o.getUserPrivacySettings)().online
            );
          });
        const n = r(62857),
          o = r(52757);
        var i;
        !(function (e) {
          (e.all = "all"), (e.match_last_seen = "match_last_seen");
        })(i || (t.setOnlineTypes = i = {}));
      },
      84474: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setProfilePicTypes = void 0),
          (t.setProfilePic = async function (e, t) {
            if ("string" != typeof e || !Object.values(s).includes(e))
              throw new o.WPPError(
                "incorrect_type",
                `Incorrect type ${e || "<empty>"} for set profile pic privacy`,
                { value: e }
              );
            const r = await (0, a.prepareDisallowedList)(
              n.PrivacyDisallowedListType.ProfilePicture,
              e,
              t
            );
            return (
              await (0, i.setPrivacyForOneCategory)(
                {
                  name: n.PrivacyDisallowedListType.ProfilePicture,
                  value: e,
                  dhash: "contact_blacklist" === e ? r.dhash : null,
                  users: "contact_blacklist" === e ? r.idsFormatted : void 0,
                },
              ...
              (0, i.getUserPrivacySettings)().profilePicture
            );
          });
        const n = r(83734),
          o = r(62857),
      ...
      81096: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setReadReceiptsTypes = void 0),
          (t.setReadReceipts = async function (e) {
            if ("string" != typeof e || !Object.values(i).includes(e))
              throw new n.WPPError(
                "incorrect_type",
                `Incorrect type ${
                  e || "<empty>"
                } for set read receipts privacy`,
                { value: e }
              );
            return (
              await (0, o.setPrivacyForOneCategory)({
              ...
              (0, o.getUserPrivacySettings)().readReceipts
            );
          });
        const n = r(62857),
          o = r(52757);
      ...
      85019: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setStatusTypes = void 0),
          (t.setStatus = async function (e, t) {
            if ("string" != typeof e || !Object.values(a).includes(e))
              throw new o.WPPError(
                "incorrect_type",
                `Incorrect type ${e || "<empty>"} for set about privacy`,
                { value: e }
              );
            if ((e == a.ALLOW_LIST || e == a.DENY_LIST) && !t)
              throw new o.WPPError(
                "list_is_mandatory",
            ...
            if (t) {
              ...
              await (0, i.setStatusPrivacyConfig)({ setting: e, list: [] });
        ...
        !(function (e) {
          (e.contact = "contact"),
            (e.DENY_LIST = "deny-list"),
            (e.ALLOW_LIST = "allow-list");
      ...
      40923: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.editBusinessProfile = async function (e) {
            if (!n.Conn.isSMB) return;
            await (0, o.editBusinessProfile)(e);
            return await n.BusinessProfileStore.fetchBizProfile(
      ...
      82807: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getMyProfilePicture = async function () {
            return await n.ProfilePicThumbStore.find(
              n.UserPrefs.getMaybeMeUser()
            );
          });
        const n = r(14647);
      ...
      23144: (e, t, r) => {
        ...
        var i = r(82807);
        Object.defineProperty(t, "getMyProfilePicture", {
          enumerable: !0,
          get: function () {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setMyProfilePicture = async function (e) {
            const t = await (0, n.convertToFile)(e),
              ...
              a = await (0, n.resizeImage)(t, {
                width: 640,
                height: 640,
                mimeType: "image/jpeg",
                resize: "cover",
              }),
              s = await (0, n.blobToBase64)(r),
              u = await (0, n.blobToBase64)(a),
              c = o.UserPrefs.getMaybeMeUser();
            return (0, i.sendSetPicture)(c, s, u);
          });
        const n = r(62857),
          o = r(14647),
          i = r(52757);
      ...
      48736: function (e, t, r) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setMyStatus = async function (e) {
            await s.setMyStatus(e);
            const t = await a.StatusStore.find(a.UserPrefs.getMaybeMeUser());
            t && (t.status = e);
            return !0;
          });
        const a = r(14647),
      ...
      28227: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.postSendStatus = function (e) {
            e.sendMsgResult.then(async () => {
              const t = n.MsgStore.get(e.id);
              if (!t) return;
              n.StatusV3Store.addStatusMessages(t.author, [t]),
      ...
      68249: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.remove = async function (e) {
            const t = await (0, n.getMessageById)(e);
            try {
              return (
                await (0, a.revokeStatus)(
                  i.StatusV3Store.get(i.UserPrefs.getMeUser()),
                  t
                ),
                !0
              );
              ...
              throw new o.WPPError(
                ...
                `Error on remove status with id ${e.toString()}`
              );
            }
          });
        const n = r(74023),
      ...
      2700: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendImageStatus = async function (e, t = {}) {
            ...
            t = Object.assign(
              Object.assign(Object.assign({}, s.defaultSendStatusOptions), {
                messageId: r,
              }),
              t
            );
            return await (0, o.sendFileMessage)(
              "status@broadcast",
              e,
              Object.assign(Object.assign({}, t), {
                createChat: !0,
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendRawStatus = async function (e, t = {}) {
            const r = new c.MsgKey({
              ...
              remote: (0, a.assertWid)("status@broadcast"),
            });
            (t = Object.assign(
            ...
            const n = await s.sendRawMessage(
              "status@broadcast",
              e,
        ...
        u.onInjected(() => {
          (0, l.wrapModuleFunction)(d.createMsgProtobuf, (e, ...t) => {
            ...
            (0, l.wrapModuleFunction)(d.encryptAndSendMsg, async (e, ...t) => {
              ...
              if (
                ...
                try {
                  return (
                    await (0, d.encryptAndSendStatusMsg)(n, e, o),
                    {
                      t: n.data.t,
                      sync: null,
                      phash: null,
          ...
          u.onFullReady(() => {
            (0, l.wrapModuleFunction)(d.getABPropConfigValue, (e, ...t) => {
              ...
              (0, l.wrapModuleFunction)(d.primaryFeatureEnabled, (e, ...t) => {
                const [r] = t;
                switch (r) {
                  case "post_status_in_companion":
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendReadStatus = async function (e, t) {
            ...
            const i = (0, n.assertWid)(e),
              a = o.StatusV3Store.get(i),
              s = null == a ? void 0 : a.msgs.get(t);
            await (null == a
              ? void 0
              : a.sendReadStatus(s, null == s ? void 0 : s.mediaKeyTimestamp));
      ...
      72686: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendTextStatus = async function (e, t = {}) {
            ...
            return await (0, i.sendRawStatus)(s, t);
          });
        const n = r(41687),
          o = r(31167),
          i = r(99341);
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.updateParticipants = async function (e) {
            ...
            const a = r.map(
              ...
              s = i.WidFactory.createWid("status@broadcast");
      ...
      98281: function (e, t, r) {
        ...
        s.onFullReady(function () {
          (0, c.wrapModuleFunction)(l.handleSingleMsg, async (e, ...t) => {
            const [r, n] = t;
            if (!a.config.syncAllStatus && r.isStatusV3()) {
      ...
      13257: (e, t, r) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.createWid = function (e) {
            ...
            if (/@\w*lid\b/.test(e))
              return n.WidFactory.createUserWid(e, "lid");
            if (/^\d+$/.test(e)) return n.WidFactory.createUserWid(e, "c.us");
            if (/^\d+-\d+$/.test(e))
              return n.WidFactory.createUserWid(e, "g.us");
            if (/status$/.test(e))
              return n.WidFactory.createUserWid(e, "broadcast");
            return n.WidFactory.createWid(e);
          });
        const n = r(14647);
      },
      97016: (e, t) => {
                ...
                (o.onload = function () {
                  ...
                  const i = r.getImageData(0, 0, e.width, e.height).data,
                    ...
                    s =
                      ...
                      (a[7] << 8) +
                      a[8];
                  t(new Uint8Array(a.subarray(9, s + 9)));
                });
            });
          });
      },
      25274: (e, t) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.generateOrderUniqueId = function () {
            const e = String(Date.now()),
              t = Math.random().toFixed(4).slice(-4),
              r = e + t;
            return ("function" == typeof BigInt ? BigInt(r) : Number(r))
              .toString(36)
              .toUpperCase();
          });
      },
      ...
      73113: function (e, t, r) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.fetchRemoteLinkPreviewData = async function (e) {
            if (g[e]) return l("Link preview found in the cache", e), g[e];
          ...
          (t.generateThumbnailLinkPreviewData = async function (e) {
            if (m[e])
              return l("Thumb for link preview found in cache.", e), m[e];
            if (!d[0]) return null;
            const t = d[0];
            ...
            if (!n) return null;
            if (n.width < p || n.height < f) return null;
            const o = await (function (e) {
              ...
              c = await a.OpaqueData.createFromBase64Jpeg(i),
              g = new Uint8Array(32),
              y =
                (window.crypto.getRandomValues(g),
                { key: a.Base64.encodeB64(g), timestamp: (0, s.unixTime)() }),
              b = new AbortController(),
              h = await (0, s.uploadThumbnail)({
                thumbnail: c,
              ...
              _ = {
                ...
                thumbnailDirectPath: v.directPath,
                thumbnailSha256: h.filehash,
                thumbnailEncSha256: v.encFilehash,
      ...
      1132: function (e, t, r) {
        ...
        (t.__debug = () => (self || window).require("__debug")),
          (t.fallbackModules = {});
        const s = i.internalEv.waitFor("conn.main_init"),
        ...
        function p(e, r = !1) {
          ...
          for (const r of n)
            try {
              ...
              if (e(n, r))
                return (
                  a(`Fallback Module found: ${r} - ${e.toString()}`),
                  clearTimeout(o),
                  r
                );
            } catch (e) {
      ...
      924: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.BlocklistCollectionImpl || e.BlocklistCollection
        );
      },
      18795: (e, t, r) => {
        "use strict";
      ...
      27462: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.ChatstateCollectionImpl || e.Chatstate
        );
      },
      60193: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 });
        (0, r(54993).exportModule)(t, { Collection: "default" }, (e) =>
      ...
      39240: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.ProfilePicThumbCollectionImpl || e.ProfilePicThumbCollection
        );
      },
      79320: (e, t, r) => {
        "use strict";
      ...
      17987: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.RecentStickerCollectionImpl || e.RecentStickerCollection
        );
      },
      18393: (e, t, r) => {
        "use strict";
      ...
      85959: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.TextStatusCollectionImpl || e.TextStatusCollection
        );
      },
      23572: (e, t, r) => {
        "use strict";
        ...
        (0, r(54993).exportModule)(
          ...
          (e) =>
            e.StatusV3CollectionImpl ||
            e.StatusV3Collection ||
            e.StatusCollectionImpl ||
            e.StatusCollection
        );
      },
      87210: (e, t, r) => {
      ...
      84471: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.StickerPackCollectionImpl || e.StickerPackCollection
        );
      },
      69634: (e, t, r) => {
        "use strict";
      ...
      14774: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.LogoutReason && e.LOGOUT_REASON_CODE
        );
      },
      48486: (e, t, r) => {
        "use strict";
      ...
      54993: function (e, t, r) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.wrapModuleFunction = function (e, r) {
            ...
            const o = d.loadModule(n),
              i = m.get(e);
            if (!i) return void console.error("function path was not found");
            f.extend("wrap")(`Wrapping '${i} for module ${n}'`);
            const a = i.split("."),
              s = a.pop();
            if (!s) {
              const e = `function was not found in the module ${n}`;
              return console.error(e), void (0, c.trackException)(e);
            }
            const p = a.reduce((e, t) => (null == e ? void 0 : e[t]), o);
            p[s] =
              "getShouldAppearInList" == s
                ? (0, u.wrapShouldAppearFunction)(e.bind(p), r)
                : (0, l.wrapFunction)(e.bind(p), r);
            g.set(p[s], n), m.set(p[s], i);
          });
        const s = a(r(17833)),
          u = r(43859),
          c = r(22418),
        ...
        function y(e, t, r) {
          ...
          for (const n of Object.keys(t)) {
            ...
            Object.defineProperty(e, n, {
              ...
              get() {
                let e, t;
                const i = d.searchId(r);
                if (!i) {
                  const e = `Module ${n} was not found with ${r.toString()}`;
                  return (
                    ["revokeStatus"].includes(n) ||
                      (console.error(e), (0, c.trackException)(e)),
                    void Object.defineProperty(this, n, { get: () => {} })
                  );
                }
                const a = d.loadModule(i);
                if (Array.isArray(o)) {
                  for (const r of o)
                    if (
                      ((e = () =>
                        r
                          .split(".")
                          .reduce((e, t) => (null == e ? void 0 : e[t]), a)),
                      e())
                    ) {
                      t = r;
                      break;
      ...
      33505: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.addOrEditNoteAction && e.retrieveOnlyNoteForChatJid
        );
      },
      25736: (e, t, r) => {
        "use strict";
              ...
              return null ===
                (r =
                  null === (t = e.default) || void 0 === t
                    ? void 0
                    : t.displayName) || void 0 === r
                ? void 0
                : r.includes("BizUpdateProductQuantityCartAction");
            }
          ),
          (0, n.exportModule)(t, { deleteProductFromCart: "default" }, (e) => {
            var t, r;
            return null ===
              (r =
                null === (t = e.default) || void 0 === t
                  ...
                  : t.displayName) || void 0 === r
              ? void 0
              : r.includes("BizDeleteProductFromCartAction");
          });
      },
      55889: (e, t, r) => {
        "use strict";
        ...
        (0, o.exportModule)(
          ...
          (0, n.injectFallbackModule)("changeOptInStatusForExternalWebBeta", {
            changeOptInStatusForExternalWebBeta: async (e) => {
              await Promise.all([
                (0, s.setWhatsAppWebExternalBetaDirtyBitIdb)(!0),
                (0, s.setWhatsAppWebExternalBetaJoinedIdb)(e),
              ]),
                await (0, i.stopComms)(),
                await (0, i.startWebComms)(),
                await (0, i.startHandlingRequests)(),
                await (0, u.syncABPropsTask)(),
                await (0, a.frontendFireAndForget)(
                  "changeOptInStatusForExternalWebBeta",
                  {}
                ),
                await (0, s.setWhatsAppWebExternalBetaDirtyBitIdb)(!1);
            },
          });
      },
      58652: (e, t, r) => {
        ...
        (0, n.exportModule)(
          ...
          (0, n.exportModule)(
            ...
            (e) =>
              e.deleteCollection && e.editCollection && e.queryCollectionsIQ
          );
      },
      71400: (e, t, r) => {
        "use strict";
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.colorIndexToHex && e.getAllLabelColors
        );
      },
      37300: (e, t, r) => {
        "use strict";
        ...
        (0, o.exportModule)(
          ...
          (e) => e.getIsMyContact && e.getIsGroup
        ),
      ...
      34324: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.findChat || e.findOrCreateLatestChat
        );
      },
      49035: (e, t, r) => {
        "use strict";
      ...
      24444: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.genBotMsgSecretFromMsgSecret
        );
      },
      47440: (e, t, r) => {
        "use strict";
      ...
      89168: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.getErrorCodeFromLogoutReason
        );
      },
      86362: (e, t, r) => {
        "use strict";
      ...
      21236: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.getNumChatsPinned || e.getNumConversationsPinned
        );
      },
      29473: (e, t, r) => {
        "use strict";
      ...
      4389: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.getPrivacyDisallowedListTable
        );
      },
      65130: (e, t, r) => {
        "use strict";
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.getPushname && e.setBrowserId && e.getUserPrivacySettings
        );
      },
      21427: (e, t, r) => {
        "use strict";
      ...
      36048: (e, t, r) => {
        ...
        (0, o.exportModule)(
          ...
          (e) =>
            e.getShouldAppearInList &&
            e.getPreviewMessage &&
            e.getShowChangeNumberNotification &&
            e.getShouldShowUnreadDivider
        ),
          (0, o.exportModule)(
            t,
          ...
          (0, n.injectFallbackModule)("getShouldAppearInList", {
            getShouldAppearInList: (e) => e.shouldAppearInList,
            getPreviewMessage: (e) => e.previewMessage,
            getShowChangeNumberNotification: (e) =>
              e.showChangeNumberNotification,
            getShouldShowUnreadDivider: (e) => e.shouldShowUnreadDivider,
          }),
          (0, n.injectFallbackModule)("getHasUnread", {
            getHasUnread: (e) => e.hasUnread,
          });
      },
      27027: (e, t, r) => {
        "use strict";
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.default.getStatusList
        );
      },
      44804: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 });
        (0, r(54993).exportModule)(t, { getTableVotes: ["getTable"] }, (e) =>
          e.getTable.toString().includes("poll")
        );
      },
      22696: (e, t, r) => {
        "use strict";
        ...
        (0, o.exportModule)(
          ...
          (0, n.injectFallbackModule)("getVotes", {
            getVote: (e) => e,
            getVotes: async (e) =>
              (
                await (0, i.getTableVotes)().anyOf(
                  ["parentMsgKey"],
                  e.map((e) => e.toString())
                )
              ).map((e) => (0, a.voteFromDbRow)(e)),
          });
      },
      41968: (e, t, r) => {
        "use strict";
      ...
      5724: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.isFilterExcludedFromSearchTreatmentInInboxFlow
        );
      },
      1009: (e, t, r) => {
        "use strict";
      ...
      33750: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.labelAddAction && e.labelDeleteAction && e.labelEditAction
        );
      },
      87071: (e, t, r) => {
        "use strict";
      ...
      74323: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) =>
            ...
            (e.msgFindQuery && e.queryMessageType)
        );
      },
      92111: (e, t, r) => {
        "use strict";
      ...
      40469: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.queryOrder && e.queryOrderResponse
        );
      },
      33433: (e, t, r) => {
        "use strict";
      ...
      28081: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 });
        (0, r(54993).exportModule)(t, { revokeStatus: ["default"] }, (e) => {
          var t, r;
          return null ===
            (r =
              null === (t = e.default) || void 0 === t
        ...
        (0, u.exportModule)(
          ...
          s.injectFallbackModule("sendCreateGroup", {
            sendCreateGroup: async (e, t, r, n) =>
              (0, a.compare)(self.Debug.VERSION, "2.3000.1014489107", ">=")
                ? await (0, c.createGroup)(
                    {
                      title: e,
                      ephemeralDuration: r || 0,
                      restrict: !0,
                      announce: !0,
                ...
                : await (0, c.createGroup)(e, t, r, n).then((e) => ({
                    gid: e.wid,
                    participants: e.participants.map((e) => ({
                      userWid: e.wid,
                      code: null != e.error ? e.error.toString() : "200",
        ...
        (0, c.exportModule)(
          ...
          s.injectFallbackModule("sendJoinGroupViaInvite", {
            sendJoinGroupViaInvite: async (e) => {
              const t = await (0, a.getGroupInfoFromInviteCode)(e);
              if (u.ChatStore.get(t.id.toString())) {
                if (await (0, a.iAmMember)(t.id.toString())) return t.id;
              }
        ...
        (0, u.exportModule)(
          ...
          s.injectFallbackModule("sendQueryGroupInviteCode", {
            sendQueryGroupInviteCode: async (e) => {
              const t = await (0, a.iAmAdmin)(e);
              return await (0, c.queryGroupInviteCode)(e, t).then(
                (e) => e.code
              );
            },
          });
      ...
      40502: function (e, t, r) {
        ...
        (0, s.exportModule)(
          ...
          a.injectFallbackModule("sendRevokeGroupInviteCode", {
      ...
      59502: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          t,
          { setPin: "setPin" },
          (e) => e.setPin && !e.unpinAll && !e.getPinLimit
        );
      },
      98872: (e, t, r) => {
        "use strict";
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.websocket =
            ...
            t.contants =
              void 0),
          i(r(12105), t),
          (t.contants = a(r(19198))),
          (t.enums = a(r(20514)));
        var s = r(54993);
        Object.defineProperty(t, "_moduleIdMap", {
          enumerable: !0,
          get: function () {
            return s._moduleIdMap;
          },
        }),
          (t.functions = a(r(52757))),
          i(r(45588), t),
          i(r(51990), t),
          (t.multidevice = a(r(83703))),
          i(r(40649), t),
          (t.websocket = a(r(57411)));
      },
      84513: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 });
      ...
      47868: function (e, t, r) {
        ...
        (0, r(54993).exportModule)(
          t,
          "IsOfficialClient",
          (e) => void 0 !== e.isOfficialClient
        ),
          a.injectFallbackModule("IsOfficialClient", { isOfficialClient: !0 });
      },
      4749: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 });
      ...
      57516: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => (e.Chatstate && e.ChatstateCollection) || e.Chatstate
        );
      },
      27961: (e, t, r) => {
        "use strict";
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.ConnImpl || (e.Conn && !e.ConnImpl)
        );
      },
      89853: (e, t, r) => {
        "use strict";
      ...
      43669: function (e, t, r) {
        ...
        Object.defineProperty(c, "HistorySyncProgressModel", {
          ...
          a.injectFallbackModule("HistorySyncProgressModel", c);
      },
      74910: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 });
      ...
      53356: (e, t, r) => {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) =>
            (e.Presence && e.ChatstateCollection) || (e.Presence && e.Chatstate)
        );
      },
      62078: (e, t, r) => {
        "use strict";
      ...
      38428: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 });
        (0, r(54993).exportModule)(t, { Socket: "Socket.constructor" }, (e) => {
          var t;
      ...
      8489: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 });
        (0, r(54993).exportModule)(t, { StatusModel: ["default"] }, (e) => {
          var t;
          return null === (t = e.default) || void 0 === t
            ? void 0
            : t.prototype.__props.includes("status");
        });
      },
      77104: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 });
        (0, r(54993).exportModule)(t, { StatusV3Model: ["default"] }, (e) => {
          var t;
          return null === (t = e.default) || void 0 === t
            ? void 0
            : t.prototype.sendReadStatus;
        });
      },
      4268: (e, t, r) => {
        "use strict";
      ...
      40649: function (e, t, r) {
        ...
        for (const e of u) {
          ...
          (0, s.exportModule)(
            t,
            { [e]: ["default", r] },
            (e) => (e.default || e[r]) instanceof a[r]
          );
        }
        (0, s.exportModule)(
          t,
          ...
          (0, s.exportModule)(
            ...
            (e) =>
              e.ProductMessageListCollectionImpl ||
              e.ProductMessageListCollection
          ),
          (0, s.exportModule)(
            t,
            {
          ...
          (0, s.exportModule)(
            ...
            (e) =>
              e.BusinessProfileCollectionImpl || e.BusinessProfileCollection
          ),
          (0, s.exportModule)(
            t,
          ...
          (0, s.exportModule)(
            ...
            (e) =>
              e.ProfilePicThumbCollection || e.ProfilePicThumbCollectionImpl
          ),
          (0, s.exportModule)(
            t,
            {
      ...
      20748: (e, t) => {
        ...
        function r(e, t, r, n) {
          var o = { timer: void 0, lastArgs: [] },
            i = function () {
              for (var n = this, i = [], a = 0; a < arguments.length; a++)
                i[a] = arguments[a];
              (o.lastArgs = i),
                o.timer
